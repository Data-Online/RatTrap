...
// Sex_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Sex_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Sex_QuickSelector page.
...
public class BaseSelectorTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseTheRatTrap%dbo.Sex record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = SexTable.GetRecord(this.RecordUniqueId, true);
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public SexRecord DataSource {
            get {
                return (SexRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    SexRecord rec = null;
        ...
        public virtual SexRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return SexTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the Sex_QuickSelector page.
...
public class BaseSelectorTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(RatTrap.Business.SexRecord);
                      this.DataSource = (SexRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(RatTrap.Business.SexRecord);
                    this.DataSource = (SexRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual SexRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(SexTable.Column1, true);          
            // selCols.Add(SexTable.Column2, true);          
            // selCols.Add(SexTable.Column3, true);          
                  ...
                  
            {
                ...
                return SexTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                SexTable databaseTable = new SexTable();
                ...
                return (recList.ToArray(typeof(SexRecord)) as SexRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return SexTable.GetRecordCount(join, where);
            else
            {
                SexTable databaseTable = new SexTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = SexTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, SexTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = SexTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            SexTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = SexTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            RatTrap.Business.SexRecord[] recordList  = SexTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (SexRecord rec in recordList ){
      ...
      SexRecord rec = new SexRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new SexRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.SexRecord);
                this.DataSource = (SexRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = SexTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  SexRecord[] DataSource {
            ...
            get {
                return (SexRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Sex_QuickSelector.SelectorTableControlRow")));
