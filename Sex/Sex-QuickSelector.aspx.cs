...
// This file implements the code-behind class for Sex_QuickSelector.aspx.
// Sex_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class Sex_QuickSelector
        : BaseApplicationPage
// Code-behind class for the Sex_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Sex_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Sex_QuickSelector.SelectorTableControl SelectorTableControl;
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        RatTrap.UI.Controls.Sex_QuickSelector.SelectorTableControl control = new RatTrap.UI.Controls.Sex_QuickSelector.SelectorTableControl();
