...
// Show_Groups.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_Groups
{
...
// Base class for the GroupsRecordControl control on the Show_Groups page.
...
public class BaseGroupsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in GroupsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Groups"] = recId;
