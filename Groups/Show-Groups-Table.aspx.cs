...
// This file implements the code-behind class for Show_Groups_Table.aspx.
// Show_Groups_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Groups_Table
        : BaseApplicationPage
// Code-behind class for the Show_Groups_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Groups_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_SearchText2(string prefixText, int count)
        {
            // GetSearchText2CompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_SearchText2_Base()
            // or replace the call to GetAutoCompletionList_SearchText2_Base().
            return GetAutoCompletionList_SearchText2_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        RatTrap.UI.Controls.Show_Groups_Table.GroupsTableControl control = new RatTrap.UI.Controls.Show_Groups_Table.GroupsTableControl();
    ...
    public static string[] GetAutoCompletionList_SearchText1_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        RatTrap.UI.Controls.Show_Groups_Table.ProjectsTableControl control = new RatTrap.UI.Controls.Show_Groups_Table.ProjectsTableControl();
        
        return control.GetAutoCompletionList_SearchText1(prefixText, count);
            
    }
      
    public static string[] GetAutoCompletionList_SearchText2_Base(string prefixText, int count)
    {
        // Since this method is a shared/static method it does not maintain information about page or controls within the page.
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        RatTrap.UI.Controls.Show_Groups_Table.UsersTableControl control = new RatTrap.UI.Controls.Show_Groups_Table.UsersTableControl();
        
        return control.GetAutoCompletionList_SearchText2(prefixText, count);
