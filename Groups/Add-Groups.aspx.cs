...
// This file implements the code-behind class for Add_Groups.aspx.
// Add_Groups.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Groups
        : BaseApplicationPage
// Code-behind class for the Add_Groups page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetGroupsRecordControl()
        {
            SetGroupsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_Groups.GroupsRecordControl GroupsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Groups");
      ...
      public void SaveData_Base()
      {
        ...
        this.GroupsRecordControl.SaveData();
        ...
        SetGroupsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "GroupsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetGroupsRecordControl_Base()           
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.GroupsRecordControl != null && this.GroupsRecordControl.DataSource != null)
                  {
                        id = this.GroupsRecordControl.DataSource.GetValue(this.GroupsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.GroupsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.GroupsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.GroupsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.GroupsRecordControl.DataSource.GetValue(this.GroupsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
