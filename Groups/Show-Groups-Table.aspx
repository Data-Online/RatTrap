...
<%@ Register Tagprefix="RatTrap" Namespace="RatTrap.UI.Controls.Show_Groups_Table" Assembly="RatTrap" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot;Groups&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:QuickSelector runat="server" id="GroupNameFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="GroupsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="3" style="display:none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th></tr><asp:Repeater runat="server" id="GroupsTableControlRepeater">		<ITEMTEMPLATE>		<RatTrap:GroupsTableControlRow runat="server" id="GroupsTableControlRow">
...
<asp:AutoCompleteExtender id="SearchText1AutoCompleteExtender" runat="server" TargetControlID="SearchText1" ServiceMethod="GetAutoCompletionList_SearchText1" MinimumPrefixLength="2" CompletionInterval="700" CompletionSetCount="10" CompletionListCssClass="autotypeahead_completionListElement" CompletionListItemCssClass="autotypeahead_listItem " CompletionListHighlightedItemCssClass="autotypeahead_highlightedListItem">
              ...
              <%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("SearchButton1"))%>
                ...
                <asp:ImageButton runat="server" id="SearchButton1" causesvalidation="False" commandname="Search" imageurl="../Images/panelSearchButton.png" tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;RatTrap&quot;) %>">		
                          ...
                          <table cellpadding="0" cellspacing="0" border="0"><tr><td class="popupTableCellLabel"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td style="text-align: right;" class="popupTableCellValue"><input type="image" src="../Images/closeButton.gif" onmouseover="this.src='../Images/closeButtonOver.gif'" onmouseout="this.src='../Images/closeButton.gif'" alt="" onclick="ISD_HidePopupPanel();return false;" align="top" /><br /></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="ShowSelectedFilterLabel" Text="Projects">	</asp:Literal></td><td colspan="2" class="popupTableCellValue">
                            <asp:DropDownList runat="server" id="ShowSelectedFilter" cssclass="Filter_Input">	</asp:DropDownList>
                          </td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"></td><td colspan="2" class="popupTableCellValue"></td><td class="popupTableCellValue"><RatTrap:ThemeButton runat="server" id="FilterButton1" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;RatTrap&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;RatTrap&quot;) %>" postback="False"></RatTrap:ThemeButton></td><td class="popupTableCellValue">
...
<tr><td class="tableCellSelectCheckbox">
	...
	<input type="hidden" id="_AddValuesProjectsTableControl" name="AddValuesProjectsTableControl" runat="server" />
	<input type="hidden" id="_RemoveValuesProjectsTableControl" name="RemoveValuesProjectsTableControl" runat="server" />
	<asp:hiddenfield id="ProjectsTableControl_PostbackTracker" runat="server" />
</RatTrap:ProjectsTableControl>

 </ContentTemplate></BaseClasses:TabPanel>
 <BaseClasses:TabPanel runat="server" id="UsersTabPanel" HeaderText="Members">	<ContentTemplate>
  <RatTrap:UsersTableControl runat="server" id="UsersTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
...
<BaseClasses:QuickSelector runat="server" id="FirstNameFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton2"))%>
</td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="ShowSelectedFilterLabel1" Text="Users">	</asp:Literal></td><td colspan="2" class="popupTableCellValue">
...
</BaseClasses:TabContainer></td></tr><tr><td class="tableRowDivider" colspan="9"></td></tr></RatTrap:GroupsTableControlRow>
</ITEMTEMPLATE>
