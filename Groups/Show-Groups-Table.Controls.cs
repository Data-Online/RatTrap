...
// Show_Groups_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_Groups_Table
{
...
public class ProjectsTableControlRow : BaseProjectsTableControlRow
{
        ...
        // The BaseProjectsTableControlRow implements code for a ROW within the
        // the ProjectsTableControl table.  The BaseProjectsTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of ProjectsTableControl.
...
public class ProjectsTableControl : BaseProjectsTableControl
{
    // The BaseProjectsTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The ProjectsTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
...
// Base class for the GroupsTableControlRow control on the Show_Groups_Table page.
...
public class BaseGroupsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        
        {
            ...
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "GroupsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "GroupsTabContainer").Visible = false;
         
  
        }      
      
        public virtual void SetProjectsTableControl()           
        ...
        public virtual void SetUsersTableControl()           
        ...
        public virtual void SaveData()
        {
          ...
          ProjectsTableControl recProjectsTableControl = (ProjectsTableControl)(MiscUtils.FindControlRecursively(this, "ProjectsTableControl"));
            recProjectsTableControl.SaveData();
            UsersTableControl recUsersTableControl = (UsersTableControl)(MiscUtils.FindControlRecursively(this, "UsersTableControl"));
      ...
      this.Page.CommitTransaction(sender);
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Groups/Edit-Groups.aspx?Groups={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                GroupsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "GroupsTableControl") as GroupsTableControl);

          GroupsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (GroupsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "GroupsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
...
#region "Helper Properties"
        ...
        public ProjectsTableControl ProjectsTableControl {
            get {
                return (ProjectsTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ProjectsTableControl");
            }
        }
        
        public UsersTableControl UsersTableControl {
            get {
                return (UsersTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UsersTableControl");
            }
        }
...
// Base class for the GroupsTableControl control on the Show_Groups_Table page.
...
public class BaseGroupsTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        GroupsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "GroupsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("URL(\"Groups\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"RatTrap.Business.GroupsTable, RatTrap.Business").TableDefinition.ColumnList.GetByUniqueName(@"Groups_.GroupId"), EvaluateFormula("URL(\"Groups\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"Groups\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"Groups\")", false) == "--ANY--") whereClause.RunQuery = false;
      ...
      GroupsRecord rec = new GroupsRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Group Name {Txt:Ascending}"), "GroupName Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Group Name {Txt:Descending}"), "GroupName Desc"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Groups" ;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = GroupsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
             ...
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(GroupsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(GroupsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(GroupsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(GroupsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(GroupsTable.GroupName, "Default"));
              ...
              {
                val = GroupsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Groups-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Groups";
                // If Show-Groups-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(GroupsTable.GroupName.Name, ReportEnum.Align.Left, "${GroupName}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = GroupsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = GroupsTable.GetRecordCount(joinFilter,whereClause);
                GroupsRecord[] records = null;
                
                do
                {
                    
                    records = GroupsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( GroupsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${GroupName}", record.Format(GroupsTable.GroupName), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Groups-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Groups";
                // If Show-Groups-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual GroupsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (GroupsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_Groups_Table.GroupsTableControlRow")));
...
// Base class for the ProjectsTableControlRow control on the Show_Groups_Table page.
// Do not modify this class. Instead override any method in ProjectsTableControlRow.
public class BaseProjectsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        public BaseProjectsTableControlRow()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in ProjectsTableControlRow.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = ProjectsTable.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseProjectsTableControl when the data for the entire
            // table is loaded.
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          {
          GroupsTableControlRow groupsTableControlRowObj = (RatTrap.UI.Controls.Show_Groups_Table.GroupsTableControlRow)(MiscUtils.GetParentControlObject(this, "GroupsTableControlRow"));
              string id = "";
              if ((groupsTableControlRowObj != null) && (groupsTableControlRowObj.GetRecord() != null) && (groupsTableControlRowObj.GetRecord().IsCreated)) {
                 id = groupsTableControlRowObj.GetRecord().GetID().ToXmlString();
              }
            ProjectsTableControl projectsTableControlObj = (RatTrap.UI.Controls.Show_Groups_Table.ProjectsTableControl)(MiscUtils.GetParentControlObject(this, "ProjectsTableControl"));  
            System.Web.UI.HtmlControls.HtmlInputHidden addvalues = (System.Web.UI.HtmlControls.HtmlInputHidden)projectsTableControlObj.FindControl("_AddValuesProjectsTableControl");
            System.Web.UI.HtmlControls.HtmlInputHidden removeValues = (System.Web.UI.HtmlControls.HtmlInputHidden)projectsTableControlObj.FindControl("_RemoveValuesProjectsTableControl");
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((ProjectsTableControl)MiscUtils.GetParentControlObject(this, "ProjectsTableControl")).DataChanged = true;
                ((ProjectsTableControl)MiscUtils.GetParentControlObject(this, "ProjectsTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in ProjectsTableControlRow.
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseProjectsTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseProjectsTableControlRow_Rec"] = value;
            }
        }
...
// Base class for the ProjectsTableControl control on the Show_Groups_Table page.
// Do not modify this class. Instead override any method in ProjectsTableControl.
public class BaseProjectsTableControl : RatTrap.UI.BaseApplicationTableControl
{
         
       public BaseProjectsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(RatTrap.Business.ProjectsRecord);
                      this.DataSource = (ProjectsRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (ProjectsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
                    ...
                    Type myrec = typeof(RatTrap.Business.ProjectsRecord);
                    this.DataSource = (ProjectsRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual ProjectsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(ProjectsTable.Column1, true);          
            // selCols.Add(ProjectsTable.Column2, true);          
            // selCols.Add(ProjectsTable.Column3, true);          
                  ...
                  
            {
                ...
                return ProjectsTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                ProjectsTable databaseTable = new ProjectsTable();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(ProjectsRecord)) as ProjectsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return ProjectsTable.GetRecordCount(join, where);
            else
            {
                ProjectsTable databaseTable = new ProjectsTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ProjectsTableControlRepeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            ProjectsTableControlRow recControl = (ProjectsTableControlRow)(repItem.FindControl("ProjectsTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
                ...
                string ProjectId  = recControl.GetRecord().ProjectId.ToString();
                ...
                if (addVar != null)
                {
                    foreach(ListItem item in addVar)
                    {
                        ...
                        if ((ProjectId == KeyValue.XmlToKey(addVal[0]).ColumnValueByName("ProjectId")) && (id == KeyValue.XmlToKey(addVal[1]).ColumnValueByName("GroupId")))
                        {
                ...
                if (removeVar != null)
                {
                    foreach(ListItem item in removeVar)
                    {
                        ...
                        if ((ProjectId == KeyValue.XmlToKey(remVal[0]).ColumnValueByName("ProjectId")) && (id == KeyValue.XmlToKey(remVal[1]).ColumnValueByName("GroupId")))
                        {
              ...
              if (!hasChanged) {
                 WhereClause wc = new WhereClause();
                 CompoundFilter jFilter = new CompoundFilter();
                 wc.iAND(ProjectsGroupsLinkTable.Instance.GroupIdColumn, BaseFilter.ComparisonOperator.EqualsTo, id);
                 wc.iAND(ProjectsGroupsLinkTable.Instance.ProjectIdColumn, BaseFilter.ComparisonOperator.EqualsTo, ProjectId);

              if (ProjectsGroupsLinkTable.GetRecordCount(jFilter, wc) > 0) {              
                    recControl.SelectRow1.Checked = true;
                 }
                 else{
                    recControl.SelectRow1.Checked = false;
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for ProjectsTableControl pagination.
        ...
        {                      
          GroupsTableControlRow groupsTableControlRowObj = (RatTrap.UI.Controls.Show_Groups_Table.GroupsTableControlRow)(MiscUtils.GetParentControlObject(this, "GroupsTableControlRow"));
            ...
            if ((groupsTableControlRowObj != null) && (groupsTableControlRowObj.GetRecord() != null) && (groupsTableControlRowObj.GetRecord().IsCreated)) {
              ...
              id = groupsTableControlRowObj.GetRecord().GroupId.ToString();
        ...
        {
            string GroupId = GetParentControlPrimaryKey();
            ListItemCollection addVar = new ListItemCollection();
            ListItemCollection removeVar = new ListItemCollection();
            ...
            System.Web.UI.HtmlControls.HtmlInputHidden addvalues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.Page.FindControlRecursively("_AddValuesProjectsTableControl");
            if (addvalues != null)
            {
              addVar = serializer.Deserialize<ListItemCollection>(addvalues.Value);
            }

            System.Web.UI.HtmlControls.HtmlInputHidden removeValues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.Page.FindControlRecursively("_RemoveValuesProjectsTableControl");
              ...
              if (addVar != null)
                {
                    ...
                    {
                        string[] addVal = item.ToString().Split(new char[] { ';' });
                        if (GroupId != KeyValue.XmlToKey(addVal[1]).ColumnValueByName("GroupId"))
                        {
                            newAddVar.Add(item);
                        }
                    }
                ...
                if (removeVar != null)
                {
                    ...
                    {
                        string[] remVal = item.ToString().Split(new char[] { ';' });
                        if (GroupId != KeyValue.XmlToKey(remVal[1]).ColumnValueByName("GroupId"))
                        {
        ...
        public virtual void GetValuesFromHiddenVariable(ref ListItemCollection addVar, ref ListItemCollection removeVar)
        {
            ...
            System.Web.UI.HtmlControls.HtmlInputHidden addvalues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("_AddValuesProjectsTableControl");
            addVar = serializer.Deserialize<ListItemCollection>(addvalues.Value);

            System.Web.UI.HtmlControls.HtmlInputHidden removeValues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("_RemoveValuesProjectsTableControl");
            removeVar = serializer.Deserialize<ListItemCollection>(removeValues.Value);
        }
        ...
        public virtual void SaveData()
        {
            ...
            if (isChanged != "") {
                if (isChanged == "true") {                
                    ...
                    string ProjectId = "";
                    try{
                        GroupId = GetParentControlPrimaryKey();                           
                        ...
                        if (addVar != null)
                        {
                            ...
                            {
                                string[] addVal = item.ToString().Split(new char[] { ';' });
                                ProjectId = KeyValue.XmlToKey(addVal[0].ToString()).ColumnValueByName("ProjectId");
                                if (GroupId == KeyValue.XmlToKey(addVal[1]).ColumnValueByName("GroupId"))
                                {
                                    WhereClause wc = new WhereClause();
                                    CompoundFilter jFilter = new CompoundFilter();
                                    wc.iAND(ProjectsGroupsLinkTable.Instance.GroupIdColumn, BaseFilter.ComparisonOperator.EqualsTo, GroupId);
                                    wc.iAND(ProjectsGroupsLinkTable.Instance.ProjectIdColumn, BaseFilter.ComparisonOperator.EqualsTo, ProjectId);

                                    if (ProjectsGroupsLinkTable.GetRecordCount(jFilter, wc) == 0)
                                    {
                                      ProjectsGroupsLinkRecord rec = new ProjectsGroupsLinkRecord();
                                      rec.Parse(ProjectId, rec.TableAccess.TableDefinition.ColumnList.GetByAnyName("ProjectId"));
                        ...
                        if (removeVar != null)
                        {
                            ...
                            {
                                string[] remVal = item.ToString().Split(new char[] { ';' });
                                ProjectId = KeyValue.XmlToKey(remVal[0].ToString()).ColumnValueByName("ProjectId");
                                if (GroupId == KeyValue.XmlToKey(remVal[1]).ColumnValueByName("GroupId"))
                                {
                                    BaseClasses.Data.KeyValue myKeyValue = new BaseClasses.Data.KeyValue();
                                    myKeyValue.AddElement(ProjectsGroupsLinkTable.Instance.GroupIdColumn.InternalName, GroupId);
                                    myKeyValue.AddElement(ProjectsGroupsLinkTable.Instance.ProjectIdColumn.InternalName, ProjectId);
                                    ...
                                    string[] ProjectsGroupsLink = ProjectsGroupsLinkTable.GetValues(ProjectsGroupsLinkTable.Instance.ProjectsGroupsLinkColumn, wc, null, 1);
                                    myKeyValue.AddElement(ProjectsGroupsLinkTable.Instance.ProjectsGroupsLinkColumn.InternalName, ProjectsGroupsLink[0]);
                                    
                                    if (ProjectsGroupsLinkTable.GetRecordCount(jFilter, wc) > 0)
                                    {
                                        ProjectsGroupsLinkTable.DeleteRecord(myKeyValue);
                                    }
                                }
                            }
                        }
            ...
            foreach (ProjectsTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual CompoundFilter CreateCompoundJoinFilter()
        {
           ...
           if (this.Page != null) {
              ...
              if (MiscUtils.IsValueSelected(this.ShowSelectedFilter) && id != "") {
                 jFilter.AddJoin(ProjectsTable.ProjectId, null, ProjectsGroupsLinkTable.ProjectId, null);
              }  
      ...
      cols.Add(ProjectsTable.Description, true);
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText1, this.GetFromSession(this.SearchText1)), true, false);
           ...
           if (MiscUtils.IsValueSelected(this.ShowSelectedFilter)) {
               ...
               if (id != "") {
                   wc.iAND(ProjectsGroupsLinkTable.GroupId, BaseFilter.ComparisonOperator.EqualsTo, id, false, false);
               }             
           }   
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText1(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            RatTrap.Business.ProjectsRecord[] recordList  = ProjectsTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (ProjectsRecord rec in recordList ){
                // Exit the loop if recordList count has reached AutoTypeAheadListSize.
                if (resultList.Count >= count) {
                    break;
                }
                ...
                resultItem = rec.Format(ProjectsTable.Description);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(ProjectsTable.Description.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, ProjectsTable.Description.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (recControl.Visible && recControl.IsNewRecord) {
      ProjectsRecord rec = new ProjectsRecord();
        
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, ProjectsTable.Description);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new ProjectsRecord());
                newUIDataList.Insert(0, new Hashtable());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.ProjectsRecord);
                this.DataSource = (ProjectsRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(ProjectsTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(ProjectsTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Area {Txt:Ascending}"), "AreaId Asc"));
              
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Area {Txt:Descending}"), "AreaId Desc"));
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["ProjectsTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["ProjectsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "ProjectsTableControl_PostbackTracker").ClientID);                           
        ...
        protected virtual void SortControl1_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  {
                  SelVal1 = SelVal1.Replace(words1[words1.Length - 1], "").TrimEnd();
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in ProjectsTable.GetColumns())
                  {
                  if (ColumnNam.Name.ToUpper().Equals(SelVal1))
                  {
                  SelVal1 = ColumnNam.InternalName;
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(ProjectsTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (ProjectsTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && ProjectsTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(ProjectsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(ProjectsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = ProjectsTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  ProjectsRecord[] DataSource {
            ...
            get {
                return (ProjectsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                ProjectsTableControlRow recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "RatTrap"));
                }
        ...
        {
            int counter = 0;
            foreach (ProjectsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        public virtual ProjectsTableControlRow GetSelectedRecordControl()
        {
        ProjectsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual ProjectsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ProjectsTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Groups_Table.ProjectsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            ProjectsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "RatTrap"));
            }
            
            foreach (ProjectsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public virtual ProjectsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "ProjectsTableControlRow");
	          List<ProjectsTableControlRow> list = new List<ProjectsTableControlRow>();
	          foreach (ProjectsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the UsersTableControlRow control on the Show_Groups_Table page.
// Do not modify this class. Instead override any method in UsersTableControlRow.
public class BaseUsersTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          GroupsTableControlRow groupsTableControlRowObj = (RatTrap.UI.Controls.Show_Groups_Table.GroupsTableControlRow)(MiscUtils.GetParentControlObject(this, "GroupsTableControlRow"));
            ...
            UsersTableControl usersTableControlObj = (RatTrap.UI.Controls.Show_Groups_Table.UsersTableControl)(MiscUtils.GetParentControlObject(this, "UsersTableControl"));  
            System.Web.UI.HtmlControls.HtmlInputHidden addvalues = (System.Web.UI.HtmlControls.HtmlInputHidden)usersTableControlObj.FindControl("_AddValuesUsersTableControl");
            System.Web.UI.HtmlControls.HtmlInputHidden removeValues = (System.Web.UI.HtmlControls.HtmlInputHidden)usersTableControlObj.FindControl("_RemoveValuesUsersTableControl");
...
// Base class for the UsersTableControl control on the Show_Groups_Table page.
// Do not modify this class. Instead override any method in UsersTableControl.
public class BaseUsersTableControl : RatTrap.UI.BaseApplicationTableControl
{
       ...
       public BaseUsersTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.FirstNameFilter)) 				
                    initialVal = this.GetFromSession(this.FirstNameFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"FirstName\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] FirstNameFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in FirstNameFilteritemListFromSession)
                    {
                        if (index == 0 && item.ToString().Equals(""))
                        {
                            // do nothing
                        ...
                        {
                            this.FirstNameFilter.Items.Add(item);
                            this.FirstNameFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.FirstNameFilter.Items)
                    {
                        listItem.Selected = true;
                    }
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.SearchText2)) 				
                    initialVal = this.GetFromSession(this.SearchText2);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.SearchText2.Text = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            // Setup the button events.
                    ...
                    this.RefreshButton2.Click += RefreshButton2_Click;
            ...
            this.SortControl2.SelectedIndexChanged += new EventHandler(SortControl2_SelectedIndexChanged);
              ...
              this.FirstNameFilter.SelectedIndexChanged += FirstNameFilter_SelectedIndexChanged;                  
                        
        
         //' Setup events for others
            
          this.ShowSelectedFilter1.SelectedIndexChanged += ShowSelectedFilter1_SelectedIndexChanged;
        AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "SearchText2SearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + SearchText2.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(RatTrap.Business.UsersRecord);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            recControl.DataBind();
                ...
                string UserId0  = recControl.GetRecord().UserId0.ToString();
                ...
                if (addVar != null)
                {
                    ...
                    {
                        string[] addVal = item.ToString().Split(new char[]{';'});
                        if ((UserId0 == KeyValue.XmlToKey(addVal[0]).ColumnValueByName("UserId")) && (id == KeyValue.XmlToKey(addVal[1]).ColumnValueByName("GroupId")))
                        {
                ...
                if (removeVar != null)
                {
                    ...
                    {
                        string[] remVal = item.ToString().Split(new char[]{';'});
                        if ((UserId0 == KeyValue.XmlToKey(remVal[0]).ColumnValueByName("UserId")) && (id == KeyValue.XmlToKey(remVal[1]).ColumnValueByName("GroupId")))
                        {
              ...
              if (!hasChanged) {
                 WhereClause wc = new WhereClause();
                 CompoundFilter jFilter = new CompoundFilter();
                 wc.iAND(UsersGroupsLinkTable.Instance.GroupIdColumn, BaseFilter.ComparisonOperator.EqualsTo, id);
        ...
        public virtual void DeleteValuesFromHiddenVariable()
        {
            ...
            System.Web.UI.HtmlControls.HtmlInputHidden addvalues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.Page.FindControlRecursively("_AddValuesUsersTableControl");
            if (addvalues != null)
            {
              addVar = serializer.Deserialize<ListItemCollection>(addvalues.Value);
            }

            System.Web.UI.HtmlControls.HtmlInputHidden removeValues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.Page.FindControlRecursively("_RemoveValuesUsersTableControl");
             if (removeValues != null)
             {
                removeVar = serializer.Deserialize<ListItemCollection>(removeValues.Value);
             }
        ...
        public virtual void GetValuesFromHiddenVariable(ref ListItemCollection addVar, ref ListItemCollection removeVar)
        {
            ...
            System.Web.UI.HtmlControls.HtmlInputHidden addvalues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("_AddValuesUsersTableControl");
            addVar = serializer.Deserialize<ListItemCollection>(addvalues.Value);

            System.Web.UI.HtmlControls.HtmlInputHidden removeValues = (System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("_RemoveValuesUsersTableControl");
            removeVar = serializer.Deserialize<ListItemCollection>(removeValues.Value);
        }
                ...
                if (isChanged == "true") {                
                    ...
                    try{
                        ...
                        if (addVar != null)
                        {
                            ...
                            {
                                string[] addVal = item.ToString().Split(new char[] { ';' });
                                UserId0 = KeyValue.XmlToKey(addVal[0].ToString()).ColumnValueByName("UserId");
                                if (GroupId == KeyValue.XmlToKey(addVal[1]).ColumnValueByName("GroupId"))
                                {
                                    WhereClause wc = new WhereClause();
                                    CompoundFilter jFilter = new CompoundFilter();
                        ...
                        if (removeVar != null)
                        {
                            ...
                            {
                                string[] remVal = item.ToString().Split(new char[] { ';' });
                                UserId0 = KeyValue.XmlToKey(remVal[0].ToString()).ColumnValueByName("UserId");
                                if (GroupId == KeyValue.XmlToKey(remVal[1]).ColumnValueByName("GroupId"))
                                {
                                    BaseClasses.Data.KeyValue myKeyValue = new BaseClasses.Data.KeyValue();
        ...
        public virtual CompoundFilter CreateCompoundJoinFilter()
        {
           ...
           if (this.Page != null) {
              ...
              if (MiscUtils.IsValueSelected(this.ShowSelectedFilter1) && id != "") {
                 jFilter.AddJoin(UsersTable.UserId0, null, UsersGroupsLinkTable.UserId0, null);
              }  
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.FirstNameFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.FirstNameFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.FirstNameFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(UsersTable.FirstName, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
            ...
            if (MiscUtils.IsValueSelected(this.SearchText2)) {
                if (this.SearchText2.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.SearchText2.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.SearchText2.Text.StartsWith("...")) {
                      this.SearchText2.Text = this.SearchText2.Text.Substring(3,this.SearchText2.Text.Length-3);
                  }
                  if (this.SearchText2.Text.EndsWith("...")) {
                      this.SearchText2.Text = this.SearchText2.Text.Substring(0,this.SearchText2.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.SearchText2.Text.Length - 1;
                      while (!Char.IsWhiteSpace(SearchText2.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.SearchText2.Text = this.SearchText2.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.SearchText2, this.GetFromSession(this.SearchText2));
                // After stripping "..." see if the search text is null or empty.
                if (MiscUtils.IsValueSelected(this.SearchText2)) {
      ...
      cols.Add(UsersTable.LastName, true);
      
      cols.Add(UsersTable.FirstName, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText2, this.GetFromSession(this.SearchText2)), true, false);
           ...
           if (MiscUtils.IsValueSelected(this.ShowSelectedFilter1)) {
               ...
               if (id != "") {
                   wc.iAND(UsersGroupsLinkTable.GroupId, BaseFilter.ComparisonOperator.EqualsTo, id, false, false);
               }             
           }   
      ...
      String FirstNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "FirstNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(FirstNameFilterSelectedValue)) {

              
        if (FirstNameFilterSelectedValue != null){
                        string[] FirstNameFilteritemListFromSession = FirstNameFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in FirstNameFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(UsersTable.FirstName, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
            ...
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "SearchText2") {
                String formatedSearchText = searchText;
                // strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                if (searchText.StartsWith("...")) {
                    formatedSearchText = searchText.Substring(3,searchText.Length-3);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText2(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"SearchText2", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            RatTrap.Business.UsersRecord[] recordList  = UsersTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (UsersRecord rec in recordList ){
                ...
                resultItem = rec.Format(UsersTable.LastName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(UsersTable.LastName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, UsersTable.LastName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(UsersTable.FirstName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(UsersTable.FirstName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, UsersTable.FirstName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      UsersRecord rec = new UsersRecord();
                        ...
                        if (recControl.FirstName.Text != "") {
                            rec.Parse(recControl.FirstName.Text, UsersTable.FirstName);
                  }
        ...
        public virtual void SetFirstNameFilter()
        {
            
            ArrayList FirstNameFilterselectedFilterItemList = new ArrayList();
            string FirstNameFilteritemsString = null;
            if (this.InSession(this.FirstNameFilter))
                FirstNameFilteritemsString = this.GetFromSession(this.FirstNameFilter);
            
            if (FirstNameFilteritemsString != null)
            {
                string[] FirstNameFilteritemListFromSession = FirstNameFilteritemsString.Split(',');
                foreach (string item in FirstNameFilteritemListFromSession)
                {
                    FirstNameFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateFirstNameFilter(MiscUtils.GetSelectedValueList(this.FirstNameFilter, FirstNameFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Users/Users-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.FirstNameFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("FirstName")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.FirstNameFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(FirstNameFilter.AutoPostBack).ToLower() + ", event); return false;";
                  
                             
        }
            
        public virtual void SetSearchText2()
        {
                                            
            this.SearchText2.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.SearchText2.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("First Name {Txt:Ascending}"), "FirstName Asc"));
              
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("First Name {Txt:Descending}"), "FirstName Desc"));
              
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("Last Name {Txt:Ascending}"), "LastName Asc"));
              
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("Last Name {Txt:Descending}"), "LastName Desc"));
              
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("Email {Txt:Ascending}"), "eMail Asc"));
              
                this.SortControl2.Items.Add(new ListItem(this.Page.ExpandResourceValue("Email {Txt:Descending}"), "eMail Desc"));
        ...
        // Get the filters' data for FirstNameFilter.
                
        protected virtual void PopulateFirstNameFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_FirstNameFilter();            
            this.FirstNameFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_FirstNameFilter function.
            // It is better to customize the where clause there.
             
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(UsersTable.FirstName, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = UsersTable.GetValues(UsersTable.FirstName, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( UsersTable.FirstName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = UsersTable.FirstName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.FirstNameFilter.Items.FindByText(fvalue);
                ...
                ListItem newItem = new ListItem(fvalue, cvalue);
                this.FirstNameFilter.Items.Add(newItem);
            ...
            this.FirstNameFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.FirstNameFilter.Items.Count == 0)
                this.FirstNameFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "RatTrap"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_FirstNameFilter()
        {
            // Create a where clause for the filter FirstNameFilter.
            // This function is called by the Populate method to load the items 
            // in the FirstNameFilterQuickSelector
            ...
            FirstNameFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.FirstNameFilter, FirstNameFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (FirstNameFilterselectedFilterItemList == null || FirstNameFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in FirstNameFilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(UsersTable.FirstName, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList FirstNameFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.FirstNameFilter, null);
            string FirstNameFilterSessionString = "";
            if (FirstNameFilterselectedFilterItemList != null){
                foreach (string item in FirstNameFilterselectedFilterItemList){
                    FirstNameFilterSessionString = String.Concat(FirstNameFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.FirstNameFilter, FirstNameFilterSessionString);
                  
            this.SaveToSession(this.SearchText2, this.SearchText2.Text);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("FirstNameFilter_Ajax", FirstNameFilterSessionString);
          
      this.SaveToSession("SearchText2_Ajax", this.SearchText2.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.FirstNameFilter);
            this.RemoveFromSession(this.SearchText2);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../Users/Add-Users.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "UsersTableControl_PostbackTracker").ClientID);                           
        ...
        public virtual void SetRefreshButton2()                
              ...
              
        {
         ...
         themeButtonFilters2Button.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(FirstNameFilter))
        ...
        // event handler for ImageButton
        public virtual void RefreshButton2_Click(object sender, ImageClickEventArgs args)
        {
        ...
        public virtual void ResetButton2_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
              ...
              this.FirstNameFilter.ClearSelection();
        ...
        // event handler for FieldFilter
        protected virtual void FirstNameFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector FirstNameFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FirstNameFilter");
            }
        }              
        ...
        public System.Web.UI.WebControls.ImageButton RefreshButton2 {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RefreshButton2");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox SearchText2 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SearchText2");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual UsersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (UsersTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Groups_Table.UsersTableControlRow")));
