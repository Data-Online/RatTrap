...
<%@ Register Tagprefix="RatTrap" Namespace="RatTrap.UI.Controls.Show_Groups" Assembly="RatTrap" %>

<%@ Register Tagprefix="Selectors" Namespace="RatTrap" Assembly="RatTrap" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-Groups.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="RatTrap.UI.Show_Groups" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="GroupsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="GroupNameLabel" Text="Group Name">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="GroupName"></asp:Literal> </td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"> </td></tr></table></asp:panel>
