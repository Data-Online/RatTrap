...
// Show_Groups_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_Groups_Gallery
{
...
public class UsersGroupsLinkRecordControl : BaseUsersGroupsLinkRecordControl
{
      
        // The BaseUsersGroupsLinkRecordControl implements the LoadData, DataBind and other
...
// Base class for the GroupsTableControlRow control on the Show_Groups_Gallery page.
...
public class BaseGroupsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.GroupName.Click += GroupName_Click;
        ...
        SetUsersGroupsLinkRecordControl();
        ...
        public virtual void SetGroupName()
        {
            ...
            // Set the GroupName LinkButton on the webpage with value from the
            ...
            // this.GroupName is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.GroupNameSpecified) {
               ...
               string formattedValue = this.DataSource.Format(GroupsTable.GroupName);
                ...
                this.GroupName.Text = formattedValue;
                  ...
                  this.GroupName.ToolTip = "Go to " + this.GroupName.Text.Replace("<wbr/>", "");
        ...
        public virtual void SetUsersGroupsLinkRecordControl()           
        
        {        
            if (UsersGroupsLinkRecordControl.Visible)
            {
                UsersGroupsLinkRecordControl.LoadData();
                UsersGroupsLinkRecordControl.DataBind();
            }
        }
        ...
        public virtual void SaveData()
        {
          ...
          UsersGroupsLinkRecordControl recUsersGroupsLinkRecordControl = (UsersGroupsLinkRecordControl)(MiscUtils.FindControlRecursively(this, "UsersGroupsLinkRecordControl"));
        recUsersGroupsLinkRecordControl.SaveData();
      ...
      // To customize, override this method in GroupsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersUsersGroupsLinkRecordControl = false;
            hasFiltersUsersGroupsLinkRecordControl = hasFiltersUsersGroupsLinkRecordControl && false; // suppress warning
        ...
        public virtual void GroupName_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Groups/Show-Groups.aspx?Groups={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton GroupName {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "GroupName");
            }
        }
            
        public UsersGroupsLinkRecordControl UsersGroupsLinkRecordControl {
            get {
                return (UsersGroupsLinkRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UsersGroupsLinkRecordControl");
            }
        }
...
// Base class for the GroupsTableControl control on the Show_Groups_Gallery page.
...
public class BaseGroupsTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return GroupsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual GroupsRecord[] CopyArray(int index, GroupsRecord[,] recs, int columns)
      {
        GroupsRecord[] recsCopy = new GroupsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            GroupsRecord[,] recs = new GroupsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            GroupsRecord[] HColDataSource = new GroupsRecord[Convert.ToInt32(rows)];
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "GroupsTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              GroupsRecord[] VColDataSource = new GroupsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("GroupsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              GroupsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                GroupsTableControlRow recControl = (GroupsTableControlRow)innerRepItem.FindControl("GroupsTableControlRow");
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              ...
              GroupsTableControlRow[] recControls = this.GetRecordControls();
                foreach (GroupsTableControlRow recControl in recControls) 
		{
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Groups-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Groups";
                // If Show-Groups-Gallery.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${GroupName}", record.Format(GroupsTable.GroupName), ReportEnum.Align.Left);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Groups-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Groups";
                // If Show-Groups-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual GroupsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (GroupsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_Groups_Gallery.GroupsTableControlRow")));
...
// Base class for the UsersGroupsLinkRecordControl control on the Show_Groups_Gallery page.
// Do not modify this class. Instead override any method in UsersGroupsLinkRecordControl.
public class BaseUsersGroupsLinkRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        public BaseUsersGroupsLinkRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in UsersGroupsLinkRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.UserId0.Click += UserId0_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "UsersGroupsLinkRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            UsersGroupsLinkRecord[] recList = UsersGroupsLinkTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = UsersGroupsLinkTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void SetUserId0()
        {
            ...
            // this.UserId0 is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.UserId0Specified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.UserId0.Text = formattedValue;
                  ...
                  this.UserId0.ToolTip = "Go to " + this.UserId0.Text.Replace("<wbr/>", "");
        ...
        public virtual void SaveData()
        {
          ...
          GroupsTableControlRow parentCtrl;
      
            parentCtrl = (GroupsTableControlRow)MiscUtils.GetParentControlObject(this, "GroupsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue groupsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = groupsRecordObj;
          groupsRecordObj = tmp;
        GroupsTableControlRow groupsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "GroupsTableControlRow") as GroupsTableControlRow);
          
              if (groupsTableControlObjRow != null && groupsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(UsersGroupsLinkTable.GroupId, BaseFilter.ComparisonOperator.EqualsTo, groupsTableControlObjRow.GetRecord().GroupId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["UsersGroupsLinkRecordControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInGroupsTableControl = HttpContext.Current.Session["UsersGroupsLinkRecordControlWhereClause"] as string;
      
      if (selectedRecordInGroupsTableControl != null && KeyValue.IsXmlKey(selectedRecordInGroupsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInGroupsTableControl);
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void UserId0_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Users/Show-Users.aspx?Users={UsersGroupsLinkRecordControl:FK:FK_UsersGroupsLink_Users}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseUsersGroupsLinkRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseUsersGroupsLinkRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton UserId0 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UserId0");
            }
        }
