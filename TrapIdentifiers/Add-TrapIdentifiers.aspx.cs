...
// This file implements the code-behind class for Add_TrapIdentifiers.aspx.
// Add_TrapIdentifiers.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_TrapIdentifiers
        : BaseApplicationPage
// Code-behind class for the Add_TrapIdentifiers page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_TrapIdentifiers()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetTrapIdentifiersRecordControl()
        {
            SetTrapIdentifiersRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_TrapIdentifiers.TrapIdentifiersRecordControl TrapIdentifiersRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Trap Identifiers");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "TrapIdentifiersRecordControl":
                 SetTrapIdentifiersRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.TrapIdentifiersRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTrapIdentifiersRecordControl_Base()           
        
        {        
            if (TrapIdentifiersRecordControl.Visible)
            {
                TrapIdentifiersRecordControl.LoadData();
                TrapIdentifiersRecordControl.DataBind();
            }
        }
