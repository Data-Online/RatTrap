...
// TrapIdentifiers_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.TrapIdentifiers_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the TrapIdentifiers_QuickSelector page.
...
public class BaseSelectorTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseTheRatTrap%dbo.TrapIdentifiers record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = TrapIdentifiersTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new TrapIdentifiersRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          TrapIdentifiersTable.DeleteRecord(pkValue);
        ...
        public TrapIdentifiersRecord DataSource {
            get {
                return (TrapIdentifiersRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    TrapIdentifiersRecord rec = null;
        ...
        public virtual TrapIdentifiersRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return TrapIdentifiersTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the TrapIdentifiers_QuickSelector page.
...
public class BaseSelectorTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(RatTrap.Business.TrapIdentifiersRecord);
                      this.DataSource = (TrapIdentifiersRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(RatTrap.Business.TrapIdentifiersRecord);
                    this.DataSource = (TrapIdentifiersRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual TrapIdentifiersRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(TrapIdentifiersTable.Column1, true);          
            // selCols.Add(TrapIdentifiersTable.Column2, true);          
            // selCols.Add(TrapIdentifiersTable.Column3, true);          
                  ...
                  
            {
                ...
                return TrapIdentifiersTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                TrapIdentifiersTable databaseTable = new TrapIdentifiersTable();
                ...
                return (recList.ToArray(typeof(TrapIdentifiersRecord)) as TrapIdentifiersRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return TrapIdentifiersTable.GetRecordCount(join, where);
            else
            {
                TrapIdentifiersTable databaseTable = new TrapIdentifiersTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = TrapIdentifiersTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, TrapIdentifiersTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = TrapIdentifiersTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            TrapIdentifiersTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = TrapIdentifiersTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            RatTrap.Business.TrapIdentifiersRecord[] recordList  = TrapIdentifiersTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (TrapIdentifiersRecord rec in recordList ){
      ...
      TrapIdentifiersRecord rec = new TrapIdentifiersRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new TrapIdentifiersRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.TrapIdentifiersRecord);
                this.DataSource = (TrapIdentifiersRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = TrapIdentifiersTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  TrapIdentifiersRecord[] DataSource {
            ...
            get {
                return (TrapIdentifiersRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.TrapIdentifiers_QuickSelector.SelectorTableControlRow")));
