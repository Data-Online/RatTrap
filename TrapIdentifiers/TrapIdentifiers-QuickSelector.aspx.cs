...
// This file implements the code-behind class for TrapIdentifiers_QuickSelector.aspx.
// TrapIdentifiers_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class TrapIdentifiers_QuickSelector
        : BaseApplicationPage
// Code-behind class for the TrapIdentifiers_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public TrapIdentifiers_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.TrapIdentifiers_QuickSelector.SelectorTableControl SelectorTableControl;
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        RatTrap.UI.Controls.TrapIdentifiers_QuickSelector.SelectorTableControl control = new RatTrap.UI.Controls.TrapIdentifiers_QuickSelector.SelectorTableControl();
