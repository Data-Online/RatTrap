...
// Add_TrapRecords.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Add_TrapRecords
{
...
// Base class for the TrapRecordsRecordControl control on the Add_TrapRecords page.
...
public class BaseTrapRecordsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetBaitType()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"BaitType\")");
        ...
        public virtual void SetSex()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"Sex\")");
        ...
        public virtual void SetSpecies()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"Species\")");
      ...
      // To customize, override this method in TrapRecordsRecordControl.
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("URL(\"TrapId\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"RatTrap.Business.TrapRecordsTable, RatTrap.Business").TableDefinition.ColumnList.GetByUniqueName(@"TrapRecords_.TrapId"), EvaluateFormula("URL(\"TrapId\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
