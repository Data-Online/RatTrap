...
// This file implements the code-behind class for Add_TrapTypes.aspx.
// Add_TrapTypes.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_TrapTypes
        : BaseApplicationPage
// Code-behind class for the Add_TrapTypes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_TrapTypes()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_TrapTypes.TrapsTableControl TrapsTableControl;
          
        public System.Web.UI.WebControls.Literal TrapTypeLabel;
        
        public RatTrap.UI.Controls.Add_TrapTypes.TrapTypesRecordControl TrapTypesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Trap Types");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.TrapTypesRecordControl != null && this.TrapTypesRecordControl.DataSource != null)
                  {
                        id = this.TrapTypesRecordControl.DataSource.GetValue(this.TrapTypesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.TrapTypesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.TrapTypesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.TrapTypesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.TrapTypesRecordControl.DataSource.GetValue(this.TrapTypesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
