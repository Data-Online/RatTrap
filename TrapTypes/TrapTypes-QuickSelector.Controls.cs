...
// TrapTypes_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.TrapTypes_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the TrapTypes_QuickSelector page.
...
// Base class for the SelectorTableControl control on the TrapTypes_QuickSelector page.
...
public class BaseSelectorTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(RatTrap.Business.TrapTypesRecord);
                      this.DataSource = (TrapTypesRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(RatTrap.Business.TrapTypesRecord);
                    this.DataSource = (TrapTypesRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual TrapTypesRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(TrapTypesTable.Column1, true);          
            // selCols.Add(TrapTypesTable.Column2, true);          
            // selCols.Add(TrapTypesTable.Column3, true);          
                  ...
                  
            {
                ...
                return TrapTypesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                TrapTypesTable databaseTable = new TrapTypesTable();
                ...
                return (recList.ToArray(typeof(TrapTypesRecord)) as TrapTypesRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return TrapTypesTable.GetRecordCount(join, where);
            else
            {
                TrapTypesTable databaseTable = new TrapTypesTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = TrapTypesTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, TrapTypesTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = TrapTypesTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = TrapTypesTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            RatTrap.Business.TrapTypesRecord[] recordList  = TrapTypesTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (TrapTypesRecord rec in recordList ){
      ...
      TrapTypesRecord rec = new TrapTypesRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new TrapTypesRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.TrapTypesRecord);
                this.DataSource = (TrapTypesRecord[])(finalList.ToArray(myrec));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void AddButton_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../TrapTypes/Add-TrapTypes.aspx?TabVisible=False&SaveAndNewVisible=False";
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = TrapTypesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  TrapTypesRecord[] DataSource {
            ...
            get {
                return (TrapTypesRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.TrapTypes_QuickSelector.SelectorTableControlRow")));
