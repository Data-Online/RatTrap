...
/// Provides access to the schema information and record data of a database table or view named DatabaseTheRatTrap%dbo.Users.
/// </summary>
/// <remarks>
...
#region "IUserIdentityTable Members"
	...
	public virtual BaseClasses.Data.BaseColumn UserEmail
	{
		get
		{
			return (BaseClasses.Data.BaseColumn)this.TableDefinition.ColumnList[9];;
		}
	}
	...
	{
		return (BaseClasses.IUserRoleTable)UserRolesLinkTable.Instance;
	}
...
#region "Properties for columns"
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Users_.FirstName column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn FirstName
    {
        get
        {
            return UsersTable.Instance.FirstNameColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Users_.LastName column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn LastName
    {
        get
        {
            return UsersTable.Instance.LastNameColumn;
        }
    }
    ...
    public BaseClasses.Data.PasswordColumn PasswordColumn
    {
        get
        {
            return (BaseClasses.Data.PasswordColumn)this.TableDefinition.ColumnList[4];
        }
    }
...
#region "Shared helper methods"
    ...
    public static UsersRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (UsersRecord[])recList.ToArray(Type.GetType("RatTrap.Business.UsersRecord"));
    }   
