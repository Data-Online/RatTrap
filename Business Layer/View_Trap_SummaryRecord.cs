...
/// Also provides access to the <see cref="View_Trap_SummaryView"></see> that each record is associated with.
/// </summary>
/// <remarks>
/// <para>
...
public class View_Trap_SummaryRecord : BaseView_Trap_SummaryRecord
{
