...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Edit-Traps-Table-Admin.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="RatTrap.UI.Edit_Traps_Table_Admin" %>
...
<BaseClasses:QuickSelector runat="server" id="TrapTypeIdFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="TrapsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="3"><asp:CheckBox runat="server" id="ToggleAll" onclick="toggleAllCheckboxes(this);">	</asp:CheckBox></th><th class="thcnb"></th><th class="thc" style="text-align:left;">&nbsp; 
<asp:LinkButton runat="server" id="TrapTypeIdLabel" tooltip="Sort by Trap Type" Text="Trap Type" CausesValidation="False">	</asp:LinkButton> <br>
<asp:LinkButton runat="server" id="ProjectIdLabel1" tooltip="Sort by Project" Text="Project" CausesValidation="False">	</asp:LinkButton></th><th class="thc">&nbsp; 
<asp:LinkButton runat="server" id="TrapIdentifierIdLabel" tooltip="Sort by Trap Id" Text="Trap Identifier" CausesValidation="False">	</asp:LinkButton></th><th class="thc">&nbsp; 
<asp:LinkButton runat="server" id="GroupIdLabel" tooltip="Sort by group" Text="Allocated to Group" CausesValidation="False">	</asp:LinkButton></th><th class="thc">&nbsp; 
<asp:LinkButton runat="server" id="ActiveLabel" tooltip="Sort by active flag" Text="EvaluateFormula(&quot;= \&quot;Active?\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"></th></tr><asp:Repeater runat="server" id="TrapsTableControlRepeater">		<ITEMTEMPLATE>		<RatTrap:TrapsTableControlRow runat="server" id="TrapsTableControlRow">
...
<asp:Literal runat="server" id="TrapRecordsCountControl">	</asp:Literal></td><td class="tableCellValue" style="text-align:left;"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="8"></td><td class="tableRowDivider"></td></tr></RatTrap:TrapsTableControlRow>
</ITEMTEMPLATE>
