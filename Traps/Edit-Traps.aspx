...
<%@ Register Tagprefix="RatTrap" Namespace="RatTrap.UI.Controls.Edit_Traps" Assembly="RatTrap" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Edit-Traps.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="RatTrap.UI.Edit_Traps" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                      ...
                      </td><td class="dht" valign="middle"></td><td class="dht" style="text-align:right;font-size:10pt;"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="GroupId1"></asp:Literal></span>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="TrapsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="TrapIdentifierIdLabel" Text="Trap Identifier">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="TrapIdentifierId"></asp:Literal></td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="TrapTypeIdLabel" Text="Trap Type">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="TrapTypeId"></asp:Literal> </td><td class="tableCellLabel"></td><td class="tableCellLabel"></td><td class="tableCellLabel"><asp:Literal runat="server" id="ProjectIdLabel" Text="Assigned to Project">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<asp:LinkButton runat="server" id="SexLabel" tooltip="Sort by Sex" Text="Sex" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="TrapRecordsTableControlRepeater">		<ITEMTEMPLATE>		<RatTrap:TrapRecordsTableControlRow runat="server" id="TrapRecordsTableControlRow">
...
</td><td class="tableCellValue" rowspan="2"><asp:RadioButtonList runat="server" id="Sex" RepeatLayout="Flow"></asp:RadioButtonList></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CommentLabel" Text="Comment">	</asp:Literal></td><td class="tableCellValue" colspan="2"><asp:TextBox runat="server" id="Comment" MaxLength="200" columns="85" cssclass="field_input" rows="1" textmode="MultiLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="CommentTextBoxMaxLengthValidator" ControlToValidate="Comment" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;RatTrap&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td></tr><tr><td class="tableRowDivider" colspan="7"></td></tr></RatTrap:TrapRecordsTableControlRow>
</ITEMTEMPLATE>
