...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                      ...
                      </td><td class="dht" valign="middle"></td><td class="largeText" style="text-align:right;"><asp:Literal runat="server" id="GroupId1"></asp:Literal> </td><td class="tableCellValue" style="text-align:right;"></td><td class="tableCellValue" style="text-align:right;">&nbsp;</td><td class="tableCellValue" style="text-align:right;">&nbsp;</td><td class="tableCellValue" style="text-align:right;"><asp:ImageButton runat="server" id="ImageButton" causesvalidation="False" commandname="UpdateData" imageurl="../Images/ButtonBarSave.gif" onmouseout="this.src=&#39;../Images/ButtonBarSave.gif&#39;" onmouseover="this.src=&#39;../Images/ButtonBarSaveOver.gif&#39;" tooltip="Save data">		
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="TrapIdentifierTextBoxMaxLengthValidator" ControlToValidate="TrapIdentifier" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;RatTrap&quot;).Replace(&quot;{FieldName}&quot;, &quot;Trap Identifier&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="TrapTypeIdLabel" Text="Trap Type">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<asp:LinkButton runat="server" id="SexLabel" tooltip="Sort by Sex" Text="Sex" CausesValidation="False">	</asp:LinkButton></th><th class="thc">&nbsp; 
...
</th></tr><asp:Repeater runat="server" id="TrapRecordsTableControlRepeater">		<ITEMTEMPLATE>		<RatTrap:TrapRecordsTableControlRow runat="server" id="TrapRecordsTableControlRow">
