...
// Show_Traps.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_Traps
{
...
// Base class for the GroupsRecordControl control on the Show_Traps page.
...
public class BaseGroupsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
    ...
    RatTrap.UI.Controls.Show_Traps.TrapsRecordControl trapsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "TrapsRecordControl") as RatTrap.UI.Controls.Show_Traps.TrapsRecordControl);
          
              if (trapsRecordControlObj != null && trapsRecordControlObj.GetRecord() != null && trapsRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(GroupsTable.GroupId, BaseFilter.ComparisonOperator.EqualsTo, trapsRecordControlObj.GetRecord().GroupId.ToString());
              selectedRecordKeyValue.AddElement(GroupsTable.GroupId.InternalName, trapsRecordControlObj.GetRecord().GroupId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInTrapsRecordControl = HttpContext.Current.Session["GroupsRecordControlWhereClause"] as string;
...
// Base class for the TrapsRecordControl control on the Show_Traps page.
...
public class BaseTrapsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            GroupsRecordControl recGroupsRecordControl = (GroupsRecordControl)(MiscUtils.FindControlRecursively(this.Page, "GroupsRecordControl"));
                  
        this.Page.SetControl("GroupsRecordControl");
      ...
      // To customize, override this method in TrapsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Traps"] = recId;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void GroupId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Groups/Show-Groups.aspx?Groups={TrapsRecordControl:FK:FK_Traps_Groups1}";
