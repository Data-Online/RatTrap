...
</td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="GroupId" redirecturl=""></BaseClasses:QuickSelector> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="TrapIdentifierLabel" Text="Trap Identifier">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
