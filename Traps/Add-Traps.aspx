...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="TrapsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="GroupIdLabel" Text="Group">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="GroupId1" redirecturl=""></BaseClasses:QuickSelector></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="TrapTypeIdLabel" Text="Trap Type">	</asp:Literal></td><td class="tableCellValue"><asp:RadioButtonList runat="server" id="TrapTypeId" RepeatLayout="Flow"></asp:RadioButtonList></td><td class="tableCellValue"><asp:Literal runat="server" id="TrapIdentifierIdLabel" Text="Trap Identifier">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="TrapIdentifierId" redirecturl=""></BaseClasses:QuickSelector></td></tr></table></asp:panel>
