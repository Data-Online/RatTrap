...
// Edit_Traps.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Edit_Traps
{
    ...
    public class TrapRecordsTableControl : BaseTrapRecordsTableControl
    {
        ...
        // Control access to trap records
        // User == Only records that have been entered by logging user
        //
        protected override WhereClause CreateQueryClause()
        {

            // Restrict data to that entered by current user if they only have "user access".
            ...
            IList rolesToCheck = new List<string>();
            rolesToCheck.Add("3");  // User Access role 

            if (BaseClasses.Utils.SecurityControls.IsUserInRole(System.Web.HttpContext.Current, rolesToCheck))
            {
    ...
    //public class ProjectsGroupsLinkRecordControl : BaseProjectsGroupsLinkRecordControl
    //{
    //      
    //        // The BaseProjectsGroupsLinkRecordControl implements the LoadData, DataBind and other
    //        // methods to load and display the data in a table control.
    //
    //        // This is the ideal place to add your code customizations. For example, you can override the LoadData, 
    //        // CreateWhereClause, DataBind, SaveData, GetUIData, and Validate methods.
    ...
    //}
    //
    //public class TrapCurrentAssignmentsRecordControl : BaseTrapCurrentAssignmentsRecordControl
    //{
    //      
    //        // The BaseTrapCurrentAssignmentsRecordControl implements the LoadData, DataBind and other
    //        // methods to load and display the data in a table control.
    //
    //        // This is the ideal place to add your code customizations. For example, you can override the LoadData, 
    //        // CreateWhereClause, DataBind, SaveData, GetUIData, and Validate methods.
    ...
    //}
    //
    //public class TrapsRecordControl1 : BaseTrapsRecordControl1
    //{
    //      
    //        // The BaseTrapsRecordControl1 implements the LoadData, DataBind and other
    //        // methods to load and display the data in a table control.
    //
    //        // This is the ideal place to add your code customizations. For example, you can override the LoadData, 
    //        // CreateWhereClause, DataBind, SaveData, GetUIData, and Validate methods.
...
// Base class for the TrapNotesTableControlRow control on the Edit_Traps page.
...
// Base class for the TrapNotesTableControl control on the Edit_Traps page.
...
public class BaseTrapNotesTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    RatTrap.UI.Controls.Edit_Traps.TrapsRecordControl trapsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "TrapsRecordControl") as RatTrap.UI.Controls.Edit_Traps.TrapsRecordControl);
...
#region "Helper Functions"
        ...
        public virtual TrapNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TrapNotesTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Edit_Traps.TrapNotesTableControlRow")));
...
// Base class for the TrapRecordsTableControlRow control on the Edit_Traps page.
...
// Base class for the TrapRecordsTableControl control on the Edit_Traps page.
...
#region "Helper Functions"
        ...
        public virtual TrapRecordsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TrapRecordsTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Edit_Traps.TrapRecordsTableControlRow")));
...
// Base class for the TrapsRecordControl control on the Edit_Traps page.
...
public class BaseTrapsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in TrapsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Traps"] = recId;
