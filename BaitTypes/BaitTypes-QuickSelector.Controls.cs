...
// BaitTypes_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.BaitTypes_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the BaitTypes_QuickSelector page.
...
public class BaseSelectorTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseTheRatTrap%dbo.BaitTypes record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = BaitTypesTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new BaitTypesRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          BaitTypesTable.DeleteRecord(pkValue);
        ...
        public BaitTypesRecord DataSource {
            get {
                return (BaitTypesRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    BaitTypesRecord rec = null;
        ...
        public virtual BaitTypesRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return BaitTypesTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the BaitTypes_QuickSelector page.
...
public class BaseSelectorTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(RatTrap.Business.BaitTypesRecord);
                      this.DataSource = (BaitTypesRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(RatTrap.Business.BaitTypesRecord);
                    this.DataSource = (BaitTypesRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual BaitTypesRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(BaitTypesTable.Column1, true);          
            // selCols.Add(BaitTypesTable.Column2, true);          
            // selCols.Add(BaitTypesTable.Column3, true);          
                  ...
                  
            {
                ...
                return BaitTypesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                BaitTypesTable databaseTable = new BaitTypesTable();
                ...
                return (recList.ToArray(typeof(BaitTypesRecord)) as BaitTypesRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return BaitTypesTable.GetRecordCount(join, where);
            else
            {
                BaitTypesTable databaseTable = new BaitTypesTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = BaitTypesTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, BaitTypesTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = BaitTypesTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            BaitTypesTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = BaitTypesTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            RatTrap.Business.BaitTypesRecord[] recordList  = BaitTypesTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (BaitTypesRecord rec in recordList ){
      ...
      BaitTypesRecord rec = new BaitTypesRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new BaitTypesRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.BaitTypesRecord);
                this.DataSource = (BaitTypesRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = BaitTypesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  BaitTypesRecord[] DataSource {
            ...
            get {
                return (BaitTypesRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.BaitTypes_QuickSelector.SelectorTableControlRow")));
