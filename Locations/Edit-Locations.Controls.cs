...
// Edit_Locations.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Edit_Locations
{
...
// Base class for the LocationsRecordControl control on the Edit_Locations page.
...
public class BaseLocationsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "LocationsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = LocationsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in LocationsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Locations"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "RatTrap").Replace("{URL}", "Locations"));
            }
            HttpContext.Current.Session["QueryString in Edit-Locations"] = recId;
