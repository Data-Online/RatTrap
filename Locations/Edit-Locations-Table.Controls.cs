...
// Edit_Locations_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Edit_Locations_Table
{
...
// Base class for the LocationsTableControlRow control on the Edit_Locations_Table page.
...
public class BaseLocationsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetLat()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.Lat.ID))
            {
            
                this.Lat.Text = this.PreviousUIData[this.Lat.ID].ToString();
        ...
        public virtual void SetLong0()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.Long0.ID))
            {
            
                this.Long0.Text = this.PreviousUIData[this.Long0.ID].ToString();
      ...
      // To customize, override this method in LocationsTableControlRow.
        ...
        LocationsTableControl tc= ((LocationsTableControl)MiscUtils.GetParentControlObject(this, "LocationsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((LocationsTableControlRow)this);
                    }
                    this.Visible = false;
...
// Base class for the LocationsTableControl control on the Edit_Locations_Table page.
    ...
    // Setup default pagination settings.
      ...
      LocationsRecord rec = new LocationsRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("LocationsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (LocationsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        LocationsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual LocationsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LocationsTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Edit_Locations_Table.LocationsTableControlRow")));
...
// Base class for the TrapsTableControlRow control on the Edit_Locations_Table page.
...
// Base class for the TrapsTableControl control on the Edit_Locations_Table page.
...
public class BaseTrapsTableControl : RatTrap.UI.BaseApplicationTableControl
{
       ...
       public BaseTrapsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.ActiveFilter1)) 				
                    initialVal = this.GetFromSession(this.ActiveFilter1);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"Active\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.ActiveFilter1.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.ActiveFilter1.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.ActiveFilter1.SelectedIndexChanged += new EventHandler(ActiveFilter1_SelectedIndexChanged);
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      HttpContext.Current.Session["TrapsTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
            ...
            if (MiscUtils.IsValueSelected(this.ActiveFilter1)) {
                        
                wc.iAND(TrapsTable.Active, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ActiveFilter1, this.GetFromSession(this.ActiveFilter1)), false, false);
      ...
      String ActiveFilter1SelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ActiveFilter1_Ajax"];
            if (MiscUtils.IsValueSelected(ActiveFilter1SelectedValue)) {

              
                wc.iAND(TrapsTable.Active, BaseFilter.ComparisonOperator.EqualsTo, ActiveFilter1SelectedValue, false, false);
      ...
      TrapsRecord rec = new TrapsRecord();
        ...
        public virtual void SetActiveFilter1()
        {
            
            this.PopulateActiveFilter1(MiscUtils.GetSelectedValue(this.ActiveFilter1,  GetFromSession(this.ActiveFilter1)), 500);					
        ...
        // Get the filters' data for ActiveFilter1.
                
        protected virtual void PopulateActiveFilter1(string selectedValue, int maxItems)
                    
        {
            ...
            this.ActiveFilter1.Items.Clear();
            WhereClause wc = this.CreateWhereClause_ActiveFilter1();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_ActiveFilter1 function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.ActiveFilter1.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "RatTrap"), "--ANY--"));
              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(TrapsTable.Active, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = TrapsTable.GetValues(TrapsTable.Active, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( TrapsTable.Active.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = TrapsTable.Active.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.ActiveFilter1.Items.FindByText(fvalue);
                ...
                ListItem newItem = new ListItem(fvalue, cvalue);
                this.ActiveFilter1.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.ActiveFilter1, selectedValue);
            ...
            if (this.ActiveFilter1.SelectedValue != null && this.ActiveFilter1.Items.FindByValue(this.ActiveFilter1.SelectedValue) == null)
                this.ActiveFilter1.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_ActiveFilter1()
        {
            // Create a where clause for the filter ActiveFilter1.
            // This function is called by the Populate method to load the items 
            // in the ActiveFilter1DropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.ActiveFilter1, this.ActiveFilter1.SelectedValue);
      ...
      this.SaveToSession("ActiveFilter1_Ajax", this.ActiveFilter1.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.ActiveFilter1);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../Traps/Add-Traps.aspx?LocationId={LocationsTableControlRow:FV:LocationId}&TabVisible=False&SaveAndNewVisible=False";
              ...
              
        {
         ...
         themeButtonFilters1Button.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(ActiveFilter1))
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Edit-Locations-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Traps";
                // If Edit-Locations-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void ResetButton1_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
              ...
              this.ActiveFilter1.ClearSelection();
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Edit-Locations-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Traps";
                // If Edit-Locations-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for FieldFilter
        protected virtual void ActiveFilter1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList ActiveFilter1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ActiveFilter1");
            }
        }
        
        public System.Web.UI.WebControls.Literal ActiveLabel2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ActiveLabel2");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual TrapsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TrapsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Edit_Locations_Table.TrapsTableControlRow")));
