...
// Add_Locations.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Add_Locations
{
...
public class LocationsRecordControl : BaseLocationsRecordControl
{
      
        // The BaseLocationsRecordControl implements the LoadData, DataBind and other
...
// Base class for the LocationsRecordControl control on the Add_Locations page.
// Do not modify this class. Instead override any method in LocationsRecordControl.
public class BaseLocationsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        public BaseLocationsRecordControl()
        {
        ...
        // To customize, override this method in LocationsRecordControl.
        ...
        {      
              ...
              this.GroupId.TextChanged += GroupId_TextChanged;
        ...
        public virtual void SetGroupId()
        {
            ...
            // Set the GroupId TextBox on the webpage with value from the
            // DatabaseTheRatTrap%dbo.Locations database record.

            // this.DataSource is the DatabaseTheRatTrap%dbo.Locations record retrieved from the database.
            // this.GroupId is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.IsCreated) {
                								
                // If the GroupId is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = this.DataSource.GroupId.ToString();
        ...
        public virtual void GetGroupId()
        {
            ...
            // Retrieve the value entered by the user on the GroupId ASP:TextBox, and
            // save it into the GroupId field in DataSource DatabaseTheRatTrap%dbo.Locations record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.GroupId.Text, LocationsTable.GroupId);							
      ...
      // To customize, override this method in LocationsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersLocationsRecordControl = false;
            hasFiltersLocationsRecordControl = hasFiltersLocationsRecordControl && false; // suppress warning
            ...
            string recId = this.Page.Request.QueryString["Locations"];
            ...
            HttpContext.Current.Session["QueryString in Add-Locations"] = recId;
          ...
          wc.iAND(LocationsTable.LocationId, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(LocationsTable.LocationId));
             
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(LocationsTable.LocationId, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        protected virtual void GroupId_TextChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseLocationsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseLocationsRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox GroupId {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "GroupId");
            }
        }
