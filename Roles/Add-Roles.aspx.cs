...
// This file implements the code-behind class for Add_Roles.aspx.
// Add_Roles.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Roles
        : BaseApplicationPage
// Code-behind class for the Add_Roles page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRoles1TabContainer()
        {
            SetRoles1TabContainer_Base(); 
        }
        
        public void SetRoles1RecordControl()
        {
            SetRoles1RecordControl_Base(); 
        }
        
        public void SetUserRolesLinkTableControl()
        {
            SetUserRolesLinkTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_Roles.Roles1RecordControl Roles1RecordControl;
          
        public AjaxControlToolkit.TabContainer Roles1TabContainer;
        ...
        public RatTrap.UI.Controls.Add_Roles.UserRolesLinkTableControl UserRolesLinkTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Roles");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Roles1RecordControl":
                 SetRoles1RecordControl();
                 break;
          
              case "UserRolesLinkTableControl":
                 SetUserRolesLinkTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Roles1RecordControl.SaveData();
        ...
        SetRoles1RecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "Roles1MenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRoles1TabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "Roles1TabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "Roles1TabContainer").Visible = false;
         
  
        }      
      
        public void SetRoles1RecordControl_Base()           
        
        {        
            if (Roles1RecordControl.Visible)
            {
                Roles1RecordControl.LoadData();
                Roles1RecordControl.DataBind();
            }
        }
      
        public void SetUserRolesLinkTableControl_Base()           
        
        {        
            if (UserRolesLinkTableControl.Visible)
            {
                UserRolesLinkTableControl.LoadData();
                UserRolesLinkTableControl.DataBind();
            }
        }
              ...
              
        {
            ...
            if (EvaluateFormula("URL(\"SaveAndNewVisible\")").ToLower() == "true") 
                ...
                MiscUtils.FindControlRecursively(this, "SaveAndNewButton").Visible = false;
                    ...
                    this.SaveAndNewButton.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.GetResourceValue("Txt:SaveRecord", "RatTrap") + "\");");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Roles1RecordControl != null && this.Roles1RecordControl.DataSource != null)
                  {
                        id = this.Roles1RecordControl.DataSource.GetValue(this.Roles1RecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Roles1RecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Roles1RecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Roles1RecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Roles1RecordControl.DataSource.GetValue(this.Roles1RecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
