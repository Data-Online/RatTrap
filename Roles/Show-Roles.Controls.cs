...
// Show_Roles.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_Roles
{
...
// Base class for the UsersTableControlRow control on the Show_Roles page.
...
public class BaseUsersTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          {
          Roles1RecordControl roles1RecordControlObj = (RatTrap.UI.Controls.Show_Roles.Roles1RecordControl)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this.Page, "Roles1RecordControl"));
              string id = "";
              ...
              UsersTableControl usersTableControlObj = (RatTrap.UI.Controls.Show_Roles.UsersTableControl)(MiscUtils.GetParentControlObject(this, "UsersTableControl"));  
...
// Base class for the UsersTableControl control on the Show_Roles page.
...
#region "Helper Functions"
        ...
        public virtual UsersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (UsersTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Roles.UsersTableControlRow")));
...
// Base class for the Roles1RecordControl control on the Show_Roles page.
...
public class BaseRoles1RecordControl : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Roles1RecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Roles"] = recId;
        ...
        public virtual void DialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Roles/Edit-Roles.aspx?Roles1={PK}";
