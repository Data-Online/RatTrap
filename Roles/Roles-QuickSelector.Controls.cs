...
namespace RatTrap.UI.Controls.Roles_QuickSelector
{
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Roles_QuickSelector.SelectorTableControlRow")));
