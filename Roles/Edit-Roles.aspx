...
<%@ Register Tagprefix="RatTrap" Namespace="RatTrap.UI.Controls.Edit_Roles" Assembly="RatTrap" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Edit-Roles.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="RatTrap.UI.Edit_Roles" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                        ...
                        <RatTrap:Roles1RecordControl runat="server" id="Roles1RecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Edit&quot;),&quot;&quot;,&quot; Roles&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="RoleNameTextBoxMaxLengthValidator" ControlToValidate="RoleName" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;RatTrap&quot;).Replace(&quot;{FieldName}&quot;, &quot;Role Name&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
	...
	<asp:hiddenfield id="Roles1RecordControl_PostbackTracker" runat="server" />
</RatTrap:Roles1RecordControl>
...
</td></tr><tr><td><BaseClasses:TabContainer runat="server" id="Roles1TabContainer" panellayout="Tabbed">
 <BaseClasses:TabPanel runat="server" id="UsersTabPanel" HeaderText="Roles Users">	<ContentTemplate>
...
<BaseClasses:QuickSelector runat="server" id="FirstNameFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton1"))%>
</td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="ShowSelectedFilterLabel" Text="Users">	</asp:Literal></td><td colspan="2" class="popupTableCellValue">
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="LastName"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="UpdatedByLabel" Text="Updated By">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:LinkButton runat="server" id="UpdatedBy" causesvalidation="False" commandname="Redirect"></asp:LinkButton></span>
 </td></tr><tr><td class="tableRowDivider" colspan="7"></td></tr></RatTrap:UsersTableControlRow>
</ITEMTEMPLATE>
