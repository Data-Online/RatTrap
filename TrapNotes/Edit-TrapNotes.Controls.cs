...
// Edit_TrapNotes.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Edit_TrapNotes
{
...
// Base class for the TrapNotesRecordControl control on the Edit_TrapNotes page.
...
public class BaseTrapNotesRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCreatedBy()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = TrapNotesTable.CreatedBy.DefaultValue;
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if(_isExpandableNonCompositeForeignKey && TrapNotesTable.CreatedBy.IsApplyDisplayAs)
                            fvalue = TrapNotesTable.GetDFKA(itemValue, TrapNotesTable.CreatedBy);
        ...
        public virtual void SetTrapId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = TrapNotesTable.TrapId.DefaultValue;
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if(_isExpandableNonCompositeForeignKey && TrapNotesTable.TrapId.IsApplyDisplayAs)
                            fvalue = TrapNotesTable.GetDFKA(itemValue, TrapNotesTable.TrapId);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
        ...
        public virtual void SetUpdatedBy()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = TrapNotesTable.UpdatedBy.DefaultValue;
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if(_isExpandableNonCompositeForeignKey && TrapNotesTable.UpdatedBy.IsApplyDisplayAs)
                            fvalue = TrapNotesTable.GetDFKA(itemValue, TrapNotesTable.UpdatedBy);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                            fvalue = itemValue.Format(UsersTable.UserId0);
        ...
        public virtual void GetCreatedBy()
        {
         // Retrieve the value entered by the user on the CreatedBy ASP:QuickSelector, and
            // save it into the CreatedBy field in DataSource DatabaseTheRatTrap%dbo.TrapNotes record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.CreatedBy), TrapNotesTable.CreatedBy);			
        ...
        public virtual void GetCreatedOn()
        {
            ...
            // save it into the CreatedOn field in DataSource DatabaseTheRatTrap%dbo.TrapNotes record.
            ...
            this.DataSource.Parse(this.CreatedOn.Text, TrapNotesTable.CreatedOn);							
        ...
        public virtual void GetTrapId()
        {
         // Retrieve the value entered by the user on the TrapId ASP:QuickSelector, and
            // save it into the TrapId field in DataSource DatabaseTheRatTrap%dbo.TrapNotes record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.TrapId), TrapNotesTable.TrapId);			
        ...
        public virtual void GetUpdatedBy()
        {
         // Retrieve the value entered by the user on the UpdatedBy ASP:QuickSelector, and
            // save it into the UpdatedBy field in DataSource DatabaseTheRatTrap%dbo.TrapNotes record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.UpdatedBy), TrapNotesTable.UpdatedBy);			
        ...
        public virtual void GetUpdatedOn()
        {
            ...
            // save it into the UpdatedOn field in DataSource DatabaseTheRatTrap%dbo.TrapNotes record.
            // Parse will also validate the date to ensure it is of the proper format
            // and a valid date.  The format is verified based on the current culture 
            // settings including the order of month, day and year and the separator character.
            // Parse throws an exception if the date is invalid.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.UpdatedOn.Text, TrapNotesTable.UpdatedOn);							
      ...
      // To customize, override this method in TrapNotesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-TrapNotes"] = recId;
