...
// This file implements the code-behind class for Add_TrapNotes.aspx.
// Add_TrapNotes.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_TrapNotes
        : BaseApplicationPage
// Code-behind class for the Add_TrapNotes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_TrapNotes()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetTrapNotesRecordControl()
        {
            SetTrapNotesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_TrapNotes.TrapNotesRecordControl TrapNotesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Trap Notes");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "TrapNotesRecordControl":
                 SetTrapNotesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.TrapNotesRecordControl.SaveData();
        ...
        SetTrapNotesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "TrapNotesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTrapNotesRecordControl_Base()           
        
        {        
            if (TrapNotesRecordControl.Visible)
            {
                TrapNotesRecordControl.LoadData();
                TrapNotesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.TrapNotesRecordControl != null && this.TrapNotesRecordControl.DataSource != null)
                  {
                        id = this.TrapNotesRecordControl.DataSource.GetValue(this.TrapNotesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.TrapNotesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.TrapNotesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.TrapNotesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.TrapNotesRecordControl.DataSource.GetValue(this.TrapNotesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
