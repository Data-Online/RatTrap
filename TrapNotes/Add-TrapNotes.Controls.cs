...
// Add_TrapNotes.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Add_TrapNotes
{
...
// Base class for the TrapNotesRecordControl control on the Add_TrapNotes page.
...
public class BaseTrapNotesRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (TrapNotesRecord)TrapNotesRecord.Copy(recList[0], false);
        ...
        public virtual void SetTrapId()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"TrapId\")");
      ...
      // To customize, override this method in TrapNotesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["TrapNotes"];
            ...
            HttpContext.Current.Session["QueryString in Add-TrapNotes"] = recId;
