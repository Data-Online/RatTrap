...
// This file implements the code-behind class for Show_View_Trap_Summary_Table.aspx.
// Show_View_Trap_Summary_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_View_Trap_Summary_Table
        : BaseApplicationPage
// Code-behind class for the Show_View_Trap_Summary_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_View_Trap_Summary_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Show_View_Trap_Summary_Table.View_Trap_SummaryTableControl View_Trap_SummaryTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "View_Trap_SummaryTableControl":
                 SetView_Trap_SummaryTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.View_Trap_SummaryTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetView_Trap_SummaryTableControl_Base()           
        
        {        
            if (View_Trap_SummaryTableControl.Visible)
            {
                View_Trap_SummaryTableControl.LoadData();
                View_Trap_SummaryTableControl.DataBind();
            }
        }
