...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      protected virtual void UserStatusInit() {
        ...
        case null:
        case "":
          this.UserStatusLbl.Text = GetResourceValue("Txt:UserNotSignedIn", "RatTrap");
        break;
        default:
          this.UserStatusLbl.Text = GetResourceValue("Txt:Hello", "RatTrap");
      ...
      protected virtual void SignInButtonInit(){
        ...
        switch (((BaseApplicationPage)(this.Page)).CurrentSecurity.GetUserStatus()) {
          ...
          case "":
              ...
              this.SignIn.Text = GetResourceValue("Txt:SignIn", "RatTrap");
              this.SignIn.ToolTip = GetResourceValue("Txt:SignIn", "RatTrap");
              
            break;
          default:
          
            this.SignIn.Text = GetResourceValue("Txt:SignOut", "RatTrap");
            this.SignIn.ToolTip = GetResourceValue("Txt:SignOut", "RatTrap");
