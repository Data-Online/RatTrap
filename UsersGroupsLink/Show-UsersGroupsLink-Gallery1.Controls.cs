...
// Show_UsersGroupsLink_Gallery1.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery1
{
...
// Base class for the UsersGroupsLinkTableControlRow control on the Show_UsersGroupsLink_Gallery1 page.
...
// Base class for the UsersGroupsLinkTableControl control on the Show_UsersGroupsLink_Gallery1 page.
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "UsersGroupsLink";
                // If Show-UsersGroupsLink-Gallery1.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "UsersGroupsLink";
                // If Show-UsersGroupsLink-Gallery1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual UsersGroupsLinkTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (UsersGroupsLinkTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery1.UsersGroupsLinkTableControlRow")));
...
// Base class for the GroupsRecordControl control on the Show_UsersGroupsLink_Gallery1 page.
