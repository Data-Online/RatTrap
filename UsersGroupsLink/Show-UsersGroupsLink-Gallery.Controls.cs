...
// Show_UsersGroupsLink_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery
{
...
public class UsersGroupsLinkTableControl : BaseUsersGroupsLinkTableControl
{
    ...
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
		...
		protected override void PopulateSortControl(string selectedValue, int maxItems)
                    
        {
              ...
              //  this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("User {Txt:Ascending}"), "UserId Asc"));
              
             //   this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("User {Txt:Descending}"), "UserId Desc"));
...
// Base class for the ProjectsGroupsLinkTableControlRow control on the Show_UsersGroupsLink_Gallery page.
...
// Base class for the ProjectsGroupsLinkTableControl control on the Show_UsersGroupsLink_Gallery page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton1_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.PDFButton1.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ProjectsGroupsLink";
                // If Show-UsersGroupsLink-Gallery.PDFButton1.report specifies a valid report template,
        ...
        public virtual void WordButton1_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.WordButton1.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "ProjectsGroupsLink";
                // If Show-UsersGroupsLink-Gallery.WordButton1.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ProjectsGroupsLinkTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ProjectsGroupsLinkTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery.ProjectsGroupsLinkTableControlRow")));
...
// Base class for the TrapsTableControlRow control on the Show_UsersGroupsLink_Gallery page.
...
// Base class for the TrapsTableControl control on the Show_UsersGroupsLink_Gallery page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton2_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.PDFButton2.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Traps";
                // If Show-UsersGroupsLink-Gallery.PDFButton2.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void WordButton2_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.WordButton2.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Traps";
                // If Show-UsersGroupsLink-Gallery.WordButton2.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual TrapsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TrapsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery.TrapsTableControlRow")));
...
// Base class for the UsersGroupsLinkTableControlRow control on the Show_UsersGroupsLink_Gallery page.
...
// Base class for the UsersGroupsLinkTableControl control on the Show_UsersGroupsLink_Gallery page.
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "UsersGroupsLink";
                // If Show-UsersGroupsLink-Gallery.PDFButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 report.AddData("${UserId0}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  UsersGroupsLinkTable.UserId0.IsApplyDisplayAs){
                                     report.AddData("${UserId0}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${UserId0}", record.Format(UsersGroupsLinkTable.UserId0), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "UsersGroupsLink";
                // If Show-UsersGroupsLink-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual UsersGroupsLinkTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (UsersGroupsLinkTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery.UsersGroupsLinkTableControlRow")));
...
// Base class for the UsersGroupsLinkTableControl1Row control on the Show_UsersGroupsLink_Gallery page.
...
// Base class for the UsersGroupsLinkTableControl1 control on the Show_UsersGroupsLink_Gallery page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton3_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.PDFButton3.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "UsersGroupsLink";
                // If Show-UsersGroupsLink-Gallery.PDFButton3.report specifies a valid report template,
                // AddColumn methods will generate a report template.   
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void WordButton3_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-UsersGroupsLink-Gallery.WordButton3.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "UsersGroupsLink";
                // If Show-UsersGroupsLink-Gallery.WordButton3.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual UsersGroupsLinkTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (UsersGroupsLinkTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery.UsersGroupsLinkTableControl1Row")));
...
// Base class for the GroupsRecordControl control on the Show_UsersGroupsLink_Gallery page.
...
// Base class for the ProjectsRecordControl control on the Show_UsersGroupsLink_Gallery page.
