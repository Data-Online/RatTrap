...
<BaseClasses:QuickSelector runat="server" id="TrapTypeIdFilter1" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton1"))%>
                  ...
                  <asp:panel id="CollapsibleRegion4" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="TrapsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2"></th><th class="thc"><asp:LinkButton runat="server" id="TrapTypeIdLabel1" tooltip="Sort by TrapTypeId" Text="Trap Type" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="TrapIdentifierIdLabel" tooltip="Sort by TrapIdentifierId" Text="Trap Identifier" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="ProjectIdLabel1" tooltip="Sort by ProjectId" Text="Assigned to Project" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="LocationIdLabel" tooltip="Sort by LocationId" Text="Location" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:Label runat="server" id="Label1" Text="#Trap Records Entered">	</asp:Label><br>
<asp:Label runat="server" id="Label4" Text="group / own">	</asp:Label></th><th class="thc"><asp:LinkButton runat="server" id="ActiveLabel" tooltip="Sort by Active" Text="EvaluateFormula(&quot;= \&quot;Active?\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="TrapsTableControlRepeater">		<ITEMTEMPLATE>		<RatTrap:TrapsTableControlRow runat="server" id="TrapsTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" colspan="2">
                                ...
                                </td><td class="tableCellValue"><asp:LinkButton runat="server" id="TrapTypeId" causesvalidation="False" commandname="Redirect"></asp:LinkButton></td><td class="tableCellValue"><asp:Literal runat="server" id="TrapIdentifierId"></asp:Literal></td><td class="tableCellValue"><asp:LinkButton runat="server" id="ProjectId1" causesvalidation="False" commandname="Redirect"></asp:LinkButton></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="LocationId"></asp:Literal></span>
</td><td class="tableCellValue"><asp:Literal runat="server" id="TrapRecordsCountControl">	</asp:Literal> / 
<asp:Literal runat="server" id="TrapRecordsCountControl1">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="Active"></asp:Literal></td></tr><tr><td class="tableRowDivider" colspan="8"></td></tr></RatTrap:TrapsTableControlRow>
</ITEMTEMPLATE>
