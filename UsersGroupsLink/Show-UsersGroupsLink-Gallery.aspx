...
<td class="largeText" style="width:33%;"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
...
<RatTrap:GroupsRecordControl runat="server" id="GroupsRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td></td><td>
 ...
 <BaseClasses:TabPanel runat="server" id="TrapsTab" HeaderText="Traps">	<ContentTemplate> 
...
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" colspan="2">
 ...
 <BaseClasses:TabPanel runat="server" id="ProjectsTab" HeaderText="Associated Projects">	<ContentTemplate> 
  <RatTrap:ProjectsGroupsLinkTableControl runat="server" id="ProjectsGroupsLinkTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title1" Text="&lt;%#String.Concat(&quot;Associated with these Projects&quot;) %>">	</asp:Literal>
                      </td></tr></table>
