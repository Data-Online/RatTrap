...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-UsersGroupsLink-Gallery1.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="RatTrap.UI.Show_UsersGroupsLink_Gallery1" %>
<%@ Register Tagprefix="RatTrap" Namespace="RatTrap.UI.Controls.Show_UsersGroupsLink_Gallery1" Assembly="RatTrap" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot;Users Groups Link&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:QuickSelector runat="server" id="UserIdFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
...
<td class="galleryttc" style="width:33%;text-align:center;"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
...
<RatTrap:GroupsRecordControl runat="server" id="GroupsRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td></td><td>
                  <asp:panel id="CollapsibleRegion1" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="GroupsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="GroupNameLabel" Text="Group Name">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="GroupName"></asp:Literal> </td></tr></table></asp:panel>
