<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Culture="en-US" Inherits="RatTrap.UI.BaseApplicationPage" %>
...
<%@ Import Namespace="RatTrap.Business" %>
<%@ Import Namespace="RatTrap.Data" %>
			...
			<script runat="server">
			    ...
			    Protected Overridable Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			        ...
			        If Not IsNothing(pageType) AndAlso pageType.Equals("aspx", System.StringComparison.InvariantCultureIgnoreCase) Then
						...
						Dim rec() As ProjectsRecord = ProjectsTable.GetRecords(wc, Nothing, 0, 1)
						If rec.Length > 0 Then
							...
							End If
							pageURL = pageURL & "?" & "Projects" & "=" & param
						End If
