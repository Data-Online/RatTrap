...
// Add_Users.Controls.vb contains the Table, Row and Record control classes
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_Users.UsersRecordControl UsersRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Users");
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        {        
            if (UsersRecordControl.Visible)
            {
                UsersRecordControl.LoadData();
                UsersRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.UsersRecordControl != null && this.UsersRecordControl.DataSource != null)
                  {
                        id = this.UsersRecordControl.DataSource.GetValue(this.UsersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.UsersRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.UsersRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.UsersRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.UsersRecordControl.DataSource.GetValue(this.UsersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
