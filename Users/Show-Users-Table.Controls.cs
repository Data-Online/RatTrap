...
namespace RatTrap.UI.Controls.Show_Users_Table
{
...
// Base class for the GroupsTableControlRow control on the Show_Users_Table page.
...
public class BaseGroupsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          {
          UsersTableControlRow usersTableControlRowObj = (RatTrap.UI.Controls.Show_Users_Table.UsersTableControlRow)(MiscUtils.GetParentControlObject(this, "UsersTableControlRow"));
              string id = "";
              if ((usersTableControlRowObj != null) && (usersTableControlRowObj.GetRecord() != null) && (usersTableControlRowObj.GetRecord().IsCreated)) {
                 id = usersTableControlRowObj.GetRecord().GetID().ToXmlString();
              }
            GroupsTableControl groupsTableControlObj = (RatTrap.UI.Controls.Show_Users_Table.GroupsTableControl)(MiscUtils.GetParentControlObject(this, "GroupsTableControl"));  
...
// Base class for the GroupsTableControl control on the Show_Users_Table page.
        ...
        {                      
          UsersTableControlRow usersTableControlRowObj = (RatTrap.UI.Controls.Show_Users_Table.UsersTableControlRow)(MiscUtils.GetParentControlObject(this, "UsersTableControlRow"));
            ...
            if ((usersTableControlRowObj != null) && (usersTableControlRowObj.GetRecord() != null) && (usersTableControlRowObj.GetRecord().IsCreated)) {
              ...
              id = usersTableControlRowObj.GetRecord().UserId0.ToString();
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void RefreshButton2_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
              ...
              DeleteValuesFromHiddenVariable();
              UsersTableControl UsersTableControlObj = ((UsersTableControl)(this.Page.FindControlRecursively("UsersTableControl")));
            UsersTableControlObj.ResetData = true;
            
            UsersTableControlObj.RemoveFromSession(UsersTableControlObj, "DeletedRecordIds");
            UsersTableControlObj.DeletedRecordIds = null;
...
#region "Helper Functions"
        ...
        public virtual GroupsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (GroupsTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Users_Table.GroupsTableControlRow")));
...
// Base class for the Roles1TableControlRow control on the Show_Users_Table page.
...
public class BaseRoles1TableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          UsersTableControlRow usersTableControlRowObj = (RatTrap.UI.Controls.Show_Users_Table.UsersTableControlRow)(MiscUtils.GetParentControlObject(this, "UsersTableControlRow"));
            ...
            Roles1TableControl roles1TableControlObj = (RatTrap.UI.Controls.Show_Users_Table.Roles1TableControl)(MiscUtils.GetParentControlObject(this, "Roles1TableControl"));  
...
// Base class for the Roles1TableControl control on the Show_Users_Table page.
              ...
              
        {
              ...
              try
              {
                ...
                string javascriptCall = "";
                    ...
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "Roles1TableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
...
#region "Helper Functions"
        ...
        public virtual Roles1TableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Roles1TableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Users_Table.Roles1TableControlRow")));
...
public class BaseUsersTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetUsersTabContainer()    
        ...
        public virtual void SetRoles1TableControl()           
        ...
        public virtual void SaveData()
        {
          ...
          GroupsTableControl recGroupsTableControl = (GroupsTableControl)(MiscUtils.FindControlRecursively(this, "GroupsTableControl"));
            ...
            Roles1TableControl recRoles1TableControl = (Roles1TableControl)(MiscUtils.FindControlRecursively(this, "Roles1TableControl"));
            recRoles1TableControl.SaveData();
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                UsersTableControl panelControl = (MiscUtils.GetParentControlObject(this, "UsersTableControl") as UsersTableControl);

          UsersTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (UsersTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "UsersTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
...
#region "Helper Properties"
        ...
        public Roles1TableControl Roles1TableControl {
            get {
                return (Roles1TableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Roles1TableControl");
            }
        }
        ...
        public AjaxControlToolkit.TabContainer UsersTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UsersTabContainer");
            }
        }
...
public class BaseUsersTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        UsersTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "UsersTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Users" ;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = UsersTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
             ...
             null};
                ...
                DataForExport dataForCSV = new DataForExport(UsersTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(UsersTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
             ...
             data.ColumnList.Add(new ExcelColumn(UsersTable.FirstName, "Default"));
             data.ColumnList.Add(new ExcelColumn(UsersTable.LastName, "Default"));
              ...
              {
                val = UsersTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Users-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users";
                // If Show-Users-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(UsersTable.FirstName.Name, ReportEnum.Align.Left, "${FirstName}", ReportEnum.Align.Left, 20);
                 report.AddColumn(UsersTable.LastName.Name, ReportEnum.Align.Left, "${LastName}", ReportEnum.Align.Left, 20);
                ...
                ColumnList columns = UsersTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = UsersTable.GetRecordCount(joinFilter,whereClause);
                UsersRecord[] records = null;
                ...
                do
                {
                    ...
                    {
                        foreach ( UsersRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${UserName0}", record.Format(UsersTable.UserName0), ReportEnum.Align.Left, 300);
                             report.AddData("${FirstName}", record.Format(UsersTable.FirstName), ReportEnum.Align.Left, 300);
                             report.AddData("${LastName}", record.Format(UsersTable.LastName), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Users-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Users";
                // If Show-Users-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual UsersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (UsersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_Users_Table.UsersTableControlRow")));
