...
// This file implements the code-behind class for Show_Users_Detail.aspx.
// Show_Users_Detail.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Users_Detail
        : BaseApplicationPage
// Code-behind class for the Show_Users_Detail page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Users_Detail()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Show_Users_Detail.GroupsTableControl GroupsTableControl;
        ...
        public RatTrap.UI.Controls.Show_Users_Detail.Roles1TableControl Roles1TableControl;
        ...
        public RatTrap.UI.Controls.Show_Users_Detail.UsersRecordControl UsersRecordControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        RatTrap.UI.Controls.Show_Users_Detail.Roles1TableControl control = new RatTrap.UI.Controls.Show_Users_Detail.Roles1TableControl();
    ...
    public static string[] GetAutoCompletionList_SearchText1_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        RatTrap.UI.Controls.Show_Users_Detail.GroupsTableControl control = new RatTrap.UI.Controls.Show_Users_Detail.GroupsTableControl();
