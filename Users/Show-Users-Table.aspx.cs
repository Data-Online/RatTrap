...
// Show_Users_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Users_Table
        : BaseApplicationPage
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Show_Users_Table.UsersTableControl UsersTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        RatTrap.UI.Controls.Show_Users_Table.UsersTableControl control = new RatTrap.UI.Controls.Show_Users_Table.UsersTableControl();
    ...
    public static string[] GetAutoCompletionList_SearchText1_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        RatTrap.UI.Controls.Show_Users_Table.Roles1TableControl control = new RatTrap.UI.Controls.Show_Users_Table.Roles1TableControl();
    ...
    public static string[] GetAutoCompletionList_SearchText2_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        RatTrap.UI.Controls.Show_Users_Table.GroupsTableControl control = new RatTrap.UI.Controls.Show_Users_Table.GroupsTableControl();
