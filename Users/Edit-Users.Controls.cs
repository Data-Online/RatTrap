...
namespace RatTrap.UI.Controls.Edit_Users
{
...
public class BaseUsersRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCreatedBy()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = UsersTable.CreatedBy.DefaultValue;
        ...
        public virtual void SetUpdatedBy()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = UsersTable.UpdatedBy.DefaultValue;
        ...
        public virtual void GetFirstName()
        {
            ...
            // save it into the FirstName field in DataSource DatabaseTheRatTrap%dbo.Users record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.FirstName.Text, UsersTable.FirstName);							
        ...
        public virtual void GetLastName()
        {
            ...
            // save it into the LastName field in DataSource DatabaseTheRatTrap%dbo.Users record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.LastName.Text, UsersTable.LastName);							
        ...
        public virtual void GetPassword()
        {
            ...
            // save it into the Password field in DataSource DatabaseTheRatTrap%dbo.Users record.
        ...
        public virtual void GetUserName0()
        {
            ...
            // save it into the UserName field in DataSource DatabaseTheRatTrap%dbo.Users record.
