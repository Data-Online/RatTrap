...
namespace RatTrap.UI.Controls.Show_Users
{
...
// Base class for the GroupsTableControlRow control on the Show_Users page.
...
public class BaseGroupsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          {
          UsersRecordControl usersRecordControlObj = (RatTrap.UI.Controls.Show_Users.UsersRecordControl)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this.Page, "UsersRecordControl"));
              string id = "";
              ...
              GroupsTableControl groupsTableControlObj = (RatTrap.UI.Controls.Show_Users.GroupsTableControl)(MiscUtils.GetParentControlObject(this, "GroupsTableControl"));  
...
// Base class for the GroupsTableControl control on the Show_Users page.
...
#region "Helper Functions"
        ...
        public virtual GroupsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (GroupsTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Users.GroupsTableControlRow")));
...
// Base class for the Roles1TableControlRow control on the Show_Users page.
...
public class BaseRoles1TableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          UsersRecordControl usersRecordControlObj = (RatTrap.UI.Controls.Show_Users.UsersRecordControl)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this.Page, "UsersRecordControl"));
              ...
              Roles1TableControl roles1TableControlObj = (RatTrap.UI.Controls.Show_Users.Roles1TableControl)(MiscUtils.GetParentControlObject(this, "Roles1TableControl"));  
...
// Base class for the Roles1TableControl control on the Show_Users page.
...
#region "Helper Functions"
        ...
        public virtual Roles1TableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Roles1TableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Users.Roles1TableControlRow")));
...
public class BaseUsersRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCreatedBy()
        {
            ...
            if (this.DataSource != null && this.DataSource.CreatedBySpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&UsersTable.CreatedBy.IsApplyDisplayAs)
                     ...
                     formattedValue = UsersTable.GetDFKA(this.DataSource.CreatedBy.ToString(),UsersTable.CreatedBy, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(UsersTable.CreatedBy);
              ...
              this.CreatedBy.Text = UsersTable.CreatedBy.Format(UsersTable.CreatedBy.DefaultValue);
        ...
        public virtual void SetUpdatedBy()
        {
            ...
            // this.DataSource is the DatabaseTheRatTrap%dbo.Users record retrieved from the database.
            // this.UpdatedBy is the ASP:Literal on the webpage.
            ...
            // on Properties.
            if (this.UpdatedBy.Text == null ||
                this.UpdatedBy.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.UpdatedBy.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal UpdatedBy {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "UpdatedBy");
            }
        }
