...
// This file implements the code-behind class for Add_Areas.aspx.
// Add_Areas.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Areas
        : BaseApplicationPage
// Code-behind class for the Add_Areas page.
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_Areas.AreaNotesTableControl AreaNotesTableControl;
          
        public RatTrap.UI.Controls.Add_Areas.AreasRecordControl AreasRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Areas");
      ...
      public void SaveData_Base()
      {
        ...
        this.AreasRecordControl.SaveData();
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.AreasRecordControl != null && this.AreasRecordControl.DataSource != null)
                  {
                        id = this.AreasRecordControl.DataSource.GetValue(this.AreasRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.AreasRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.AreasRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.AreasRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.AreasRecordControl.DataSource.GetValue(this.AreasRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
