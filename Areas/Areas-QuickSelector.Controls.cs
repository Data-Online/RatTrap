...
// Areas_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Areas_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Areas_QuickSelector page.
...
// Base class for the SelectorTableControl control on the Areas_QuickSelector page.
...
public class BaseSelectorTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(RatTrap.Business.AreasRecord);
                      this.DataSource = (AreasRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(RatTrap.Business.AreasRecord);
                    this.DataSource = (AreasRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual AreasRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(AreasTable.Column1, true);          
            // selCols.Add(AreasTable.Column2, true);          
            // selCols.Add(AreasTable.Column3, true);          
                  ...
                  
            {
                ...
                return AreasTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                AreasTable databaseTable = new AreasTable();
                ...
                return (recList.ToArray(typeof(AreasRecord)) as AreasRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return AreasTable.GetRecordCount(join, where);
            else
            {
                AreasTable databaseTable = new AreasTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = AreasTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, AreasTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = AreasTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = AreasTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            RatTrap.Business.AreasRecord[] recordList  = AreasTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (AreasRecord rec in recordList ){
      ...
      AreasRecord rec = new AreasRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new AreasRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.AreasRecord);
                this.DataSource = (AreasRecord[])(finalList.ToArray(myrec));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void AddButton_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Areas/Add-Areas.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = AreasTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  AreasRecord[] DataSource {
            ...
            get {
                return (AreasRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Areas_QuickSelector.SelectorTableControlRow")));
