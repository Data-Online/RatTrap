...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ImportData.aspx.cs" Inherits="RatTrap.UI.ImportData" %>
<%@ Register Tagprefix="Selectors" Namespace="RatTrap" %>
				...
				<table class="importWizarddv" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="importWizarddBody" style="width:100%; height:100%">			
							...
							<table>
								<tr>
									<td><RatTrap:ThemeButton runat="server" id="PreviousButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Previous&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Previous&quot;, &quot;RatTrap&quot;) %>">
		</RatTrap:ThemeButton></td>
									<td><RatTrap:ThemeButton runat="server" id="ImportButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Import&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Import&quot;, &quot;RatTrap&quot;) %>">
		</RatTrap:ThemeButton></td>
								</tr>
							</table>
						</td>
