...
// Species_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Species_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Species_QuickSelector page.
...
public class BaseSelectorTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseTheRatTrap%dbo.Species record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = SpeciesTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new SpeciesRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          SpeciesTable.DeleteRecord(pkValue);
        ...
        public SpeciesRecord DataSource {
            get {
                return (SpeciesRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    SpeciesRecord rec = null;
        ...
        public virtual SpeciesRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return SpeciesTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the Species_QuickSelector page.
...
public class BaseSelectorTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(RatTrap.Business.SpeciesRecord);
                      this.DataSource = (SpeciesRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(RatTrap.Business.SpeciesRecord);
                    this.DataSource = (SpeciesRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual SpeciesRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(SpeciesTable.Column1, true);          
            // selCols.Add(SpeciesTable.Column2, true);          
            // selCols.Add(SpeciesTable.Column3, true);          
                  ...
                  
            {
                ...
                return SpeciesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                SpeciesTable databaseTable = new SpeciesTable();
                ...
                return (recList.ToArray(typeof(SpeciesRecord)) as SpeciesRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return SpeciesTable.GetRecordCount(join, where);
            else
            {
                SpeciesTable databaseTable = new SpeciesTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = SpeciesTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, SpeciesTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = SpeciesTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            SpeciesTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = SpeciesTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            RatTrap.Business.SpeciesRecord[] recordList  = SpeciesTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (SpeciesRecord rec in recordList ){
      ...
      SpeciesRecord rec = new SpeciesRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new SpeciesRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.SpeciesRecord);
                this.DataSource = (SpeciesRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = SpeciesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  SpeciesRecord[] DataSource {
            ...
            get {
                return (SpeciesRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Species_QuickSelector.SelectorTableControlRow")));
