...
/// <see cref="AreaNotesTable">RatTrap.AreaNotesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AreaNotesTable"></seealso>
public class AreaNotesDefinition
{
#region "Definition (XML) for AreaNotesDefinition table"
	//Next 108 lines contain Table Definition (XML) for table "AreaNotesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>AreaNotesId</columnName>");
         tbf.Append(      @"<columnUIName>Area Notes</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_AreaNotes_Areas</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>AreaNotes</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>AreaNotes_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>AreaNotes</FolderName>");
         tbf.Append(  @"<MenuName>Area Notes</MenuName>");
         tbf.Append(  @"<QSPath>../AreaNotes/AreaNotes-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>AreaNotes</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapAreaNotes</TableStoredProcPrefix>");
