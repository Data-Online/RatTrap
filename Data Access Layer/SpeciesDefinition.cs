...
/// <see cref="SpeciesTable">RatTrap.SpeciesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="SpeciesTable"></seealso>
public class SpeciesDefinition
{
#region "Definition (XML) for SpeciesDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "SpeciesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>SpeciesId</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Species</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Species_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Species</TableCodeName>");
         tbf.Append(  @"<FolderName>Species</FolderName>");
         tbf.Append(  @"<MenuName>Species</MenuName>");
         tbf.Append(  @"<QSPath>../Species/Species-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapSpecies</TableStoredProcPrefix>");
