...
/// <see cref="View_Trap_SummaryView">RatTrap.View_Trap_SummaryView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="View_Trap_SummaryView"></seealso>
public class View_Trap_SummaryDefinition
{
#region "Definition (XML) for View_Trap_SummaryDefinition table"
	//Next 261 lines contain Table Definition (XML) for table "View_Trap_SummaryDefinition"
	...
	/// <see cref="View_Trap_SummaryView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>VFK_view_Trap-Summary_GroupId_1</columnFKName>");
         tbf.Append(        @"<columnFKTable>RatTrap.Business.UsersGroupsLinkTable, RatTrap.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>GroupId</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>=UsersGroupsLink.UserGroupsId</columnFKColumnDisplay>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>view_Trap-Summary</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>view_Trap_Summary_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>View_Trap_Summary</TableCodeName>");
         tbf.Append(  @"<FolderName>view_Trap-Summary</FolderName>");
         tbf.Append(  @"<MenuName>Trap Summary</MenuName>");
         tbf.Append(  @"<QSPath>../view_Trap-Summary/View-Trap-Summary-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapView_Trap_Summary</TableStoredProcPrefix>");
