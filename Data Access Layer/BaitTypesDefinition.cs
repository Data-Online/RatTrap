...
/// <see cref="BaitTypesTable">RatTrap.BaitTypesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="BaitTypesTable"></seealso>
public class BaitTypesDefinition
{
#region "Definition (XML) for BaitTypesDefinition table"
	//Next 73 lines contain Table Definition (XML) for table "BaitTypesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>BaitTypeId</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>BaitTypes</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>BaitTypes_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>BaitTypes</FolderName>");
         tbf.Append(  @"<MenuName>Bait Types</MenuName>");
         tbf.Append(  @"<QSPath>../BaitTypes/BaitTypes-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>BaitTypes</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapBaitTypes</TableStoredProcPrefix>");
