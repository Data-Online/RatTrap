...
/// <see cref="UserRolesLinkTable">RatTrap.UserRolesLinkTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="UserRolesLinkTable"></seealso>
public class UserRolesLinkDefinition
{
#region "Definition (XML) for UserRolesLinkDefinition table"
	//Next 120 lines contain Table Definition (XML) for table "UserRolesLinkDefinition"
	...
	/// <see cref="UserRolesLinkTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>UserRolesId</columnName>");
         tbf.Append(      @"<columnUIName>User Roles</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_UserRolesLink_Users</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_UserRolesLink_Roles</columnFKName>");
         tbf.Append(        @"<columnFKTable>RatTrap.Business.Roles1Table, RatTrap.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>UserRolesLink</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>UserRolesLink_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>UserRolesLink</FolderName>");
         tbf.Append(  @"<MenuName>User Roles Link</MenuName>");
         tbf.Append(  @"<QSPath>../UserRolesLink/UserRolesLink-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>UserRolesLink</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapUserRolesLink</TableStoredProcPrefix>");
