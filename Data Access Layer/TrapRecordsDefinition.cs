...
#region "Definition (XML) for TrapRecordsDefinition table"
	//Next 664 lines contain Table Definition (XML) for table "TrapRecordsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_TrapRecords_LocationId_1</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>= Locations.Description</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<columnTableClassName></columnTableClassName>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_TrapRecords_ProjectId_1</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>= Projects.Description</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Implicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(    "</Column>");
         ...
         tbf.Append(      @"<columnTableClassName></columnTableClassName>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_TrapRecords_GroupId_1</columnFKName>");
         ...
         tbf.Append(      @"<columnTableClassName></columnTableClassName>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_TrapRecords_TrapTypeId_1</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>= TrapTypes.TrapType</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Implicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(    "</Column>");
