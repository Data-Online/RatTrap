...
/// <see cref="ProjectNotesTable">RatTrap.ProjectNotesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ProjectNotesTable"></seealso>
public class ProjectNotesDefinition
{
#region "Definition (XML) for ProjectNotesDefinition table"
	//Next 249 lines contain Table Definition (XML) for table "ProjectNotesDefinition"
	...
	/// <see cref="ProjectNotesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>ProjectNotesId</columnName>");
         tbf.Append(      @"<columnUIName>Project Notes</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_ProjectNotes_Projects1</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ProjectNotes</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ProjectNotes_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>ProjectNotes</TableCodeName>");
         tbf.Append(  @"<FolderName>ProjectNotes</FolderName>");
         tbf.Append(  @"<MenuName>Project Notes</MenuName>");
         tbf.Append(  @"<QSPath>../ProjectNotes/ProjectNotes-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapProjectNotes</TableStoredProcPrefix>");
