...
/// <see cref="AreasTable">RatTrap.AreasTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AreasTable"></seealso>
public class AreasDefinition
{
#region "Definition (XML) for AreasDefinition table"
	//Next 161 lines contain Table Definition (XML) for table "AreasDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Areas</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Areas_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Areas</TableCodeName>");
         tbf.Append(  @"<FolderName>Areas</FolderName>");
         tbf.Append(  @"<MenuName>Areas</MenuName>");
         tbf.Append(  @"<QSPath>../Areas/Areas-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapAreas</TableStoredProcPrefix>");
