...
/// <see cref="GroupsTable">RatTrap.GroupsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="GroupsTable"></seealso>
public class GroupsDefinition
{
#region "Definition (XML) for GroupsDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "GroupsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>GroupName</columnName>");
         tbf.Append(      @"<columnUIName>Group Name</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Groups</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Groups_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Groups</TableCodeName>");
         tbf.Append(  @"<FolderName>Groups</FolderName>");
         tbf.Append(  @"<MenuName>Groups</MenuName>");
         tbf.Append(  @"<QSPath>../Groups/Groups-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapGroups</TableStoredProcPrefix>");
