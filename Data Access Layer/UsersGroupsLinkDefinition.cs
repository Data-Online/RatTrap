...
/// <see cref="UsersGroupsLinkTable">RatTrap.UsersGroupsLinkTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="UsersGroupsLinkTable"></seealso>
public class UsersGroupsLinkDefinition
{
#region "Definition (XML) for UsersGroupsLinkDefinition table"
	//Next 130 lines contain Table Definition (XML) for table "UsersGroupsLinkDefinition"
	...
	/// <see cref="UsersGroupsLinkTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>UserGroupsId</columnName>");
         tbf.Append(      @"<columnUIName>User Groups</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_UsersGroupsLink_Users</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_UsersGroupsLink_Groups</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>UsersGroupsLink</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>UsersGroupsLink_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>UsersGroupsLink</FolderName>");
         tbf.Append(  @"<MenuName>Users Groups Link</MenuName>");
         tbf.Append(  @"<QSPath>../UsersGroupsLink/UsersGroupsLink-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>UsersGroupsLink</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pRatTrapUsersGroupsLink</TableStoredProcPrefix>");
