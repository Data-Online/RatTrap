...
// Show_Projects_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Show_Projects_Table
{
...
//public class AreasRecordControl : BaseAreasRecordControl
//{
//      
//        // The BaseAreasRecordControl implements the LoadData, DataBind and other
...
// Base class for the GroupsTableControlRow control on the Show_Projects_Table page.
...
public class BaseGroupsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
      ...
      RegisterRowForHiddenVariableSelection();
          ...
          {
          ProjectsTableControlRow projectsTableControlRowObj = (RatTrap.UI.Controls.Show_Projects_Table.ProjectsTableControlRow)(MiscUtils.GetParentControlObject(this, "ProjectsTableControlRow"));
              string id = "";
              if ((projectsTableControlRowObj != null) && (projectsTableControlRowObj.GetRecord() != null) && (projectsTableControlRowObj.GetRecord().IsCreated)) {
                 id = projectsTableControlRowObj.GetRecord().GetID().ToXmlString();
              }
            GroupsTableControl groupsTableControlObj = (RatTrap.UI.Controls.Show_Projects_Table.GroupsTableControl)(MiscUtils.GetParentControlObject(this, "GroupsTableControl"));  
...
// Base class for the GroupsTableControl control on the Show_Projects_Table page.
...
public class BaseGroupsTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
            ...
            recControl.DataBind();
                ...
                if (addVar != null)
                {
                    foreach(ListItem item in addVar)
                    {
                        ...
                        if ((GroupId == KeyValue.XmlToKey(addVal[0]).ColumnValueByName("GroupId")) && (id == KeyValue.XmlToKey(addVal[1]).ColumnValueByName("ProjectId")))
                        {
                ...
                if (removeVar != null)
                {
                    foreach(ListItem item in removeVar)
                    {
                        ...
                        if ((GroupId == KeyValue.XmlToKey(remVal[0]).ColumnValueByName("GroupId")) && (id == KeyValue.XmlToKey(remVal[1]).ColumnValueByName("ProjectId")))
                        {
              ...
              if (!hasChanged) {
                 ...
                 wc.iAND(ProjectsGroupsLinkTable.Instance.ProjectIdColumn, BaseFilter.ComparisonOperator.EqualsTo, id);
        ...
        {                      
          ProjectsTableControlRow projectsTableControlRowObj = (RatTrap.UI.Controls.Show_Projects_Table.ProjectsTableControlRow)(MiscUtils.GetParentControlObject(this, "ProjectsTableControlRow"));
            ...
            if ((projectsTableControlRowObj != null) && (projectsTableControlRowObj.GetRecord() != null) && (projectsTableControlRowObj.GetRecord().IsCreated)) {
              ...
              id = projectsTableControlRowObj.GetRecord().ProjectId.ToString();
        ...
        {
            string ProjectId = GetParentControlPrimaryKey();
            ListItemCollection addVar = new ListItemCollection();
            ListItemCollection removeVar = new ListItemCollection();
              ...
              if (addVar != null)
                {
                    ...
                    {
                        string[] addVal = item.ToString().Split(new char[] { ';' });
                        if (ProjectId != KeyValue.XmlToKey(addVal[1]).ColumnValueByName("ProjectId"))
                        {
                            newAddVar.Add(item);
                        }
                    }
                ...
                if (removeVar != null)
                {
                    ...
                    {
                        string[] remVal = item.ToString().Split(new char[] { ';' });
                        if (ProjectId != KeyValue.XmlToKey(remVal[1]).ColumnValueByName("ProjectId"))
                        {
        ...
        public virtual void SaveData()
        {
            ...
            if (isChanged != "") {
                if (isChanged == "true") {                
                    ...
                    string GroupId = "";
                    try{
                        ProjectId = GetParentControlPrimaryKey();                           
        ...
        public virtual CompoundFilter CreateCompoundJoinFilter()
        {
           ...
           if (this.Page != null) {
              ...
              if (MiscUtils.IsValueSelected(this.ShowSelectedFilter) && id != "") {
                 jFilter.AddJoin(GroupsTable.GroupId, null, ProjectsGroupsLinkTable.GroupId, null);
              }  
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText2, this.GetFromSession(this.SearchText2)), true, false);
           ...
           if (MiscUtils.IsValueSelected(this.ShowSelectedFilter)) {
               ...
               if (id != "") {
                   wc.iAND(ProjectsGroupsLinkTable.ProjectId, BaseFilter.ComparisonOperator.EqualsTo, id, false, false);
               }             
           }   
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void RefreshButton2_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
              ...
              DeleteValuesFromHiddenVariable();
              ProjectsTableControl ProjectsTableControlObj = ((ProjectsTableControl)(this.Page.FindControlRecursively("ProjectsTableControl")));
            ProjectsTableControlObj.ResetData = true;
            
            ProjectsTableControlObj.RemoveFromSession(ProjectsTableControlObj, "DeletedRecordIds");
            ProjectsTableControlObj.DeletedRecordIds = null;
...
#region "Helper Functions"
        ...
        public virtual GroupsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (GroupsTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Show_Projects_Table.GroupsTableControlRow")));
...
public class BaseProjectNotesTableControl1Row : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            // Load the data from the database into the DataSource DatabaseTheRatTrap%dbo.ProjectNotes record.
            // It is better to make changes to functions called by LoadData such as
            // CreateWhereClause, rather than making changes here.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = ProjectNotesTable.GetRecord(this.RecordUniqueId, true);
        ...
        ProjectsTableControlRow parentCtrl;
      
            parentCtrl = (ProjectsTableControlRow)MiscUtils.GetParentControlObject(this, "ProjectsTableControlRow");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "RatTrap"));
          ...
          this.DataSource.ProjectId = parentCtrl.DataSource.ProjectId;
      ...
      // To customize, override this method in ProjectNotesTableControl1Row.
        ...
        public virtual void Delete()
        {
            ...
            KeyValue pkValue = KeyValue.XmlToKey(this.RecordUniqueId);
          ProjectNotesTable.DeleteRecord(pkValue);
        ...
        public ProjectNotesRecord DataSource {
            get {
                return (ProjectNotesRecord)(this._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
    ...
    ProjectNotesRecord rec = null;
        ...
        public virtual ProjectNotesRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return ProjectNotesTable.GetRecord(this.RecordUniqueId, true);
...
public class BaseProjectNotesTableControl1 : RatTrap.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(RatTrap.Business.ProjectNotesRecord);
                      this.DataSource = (ProjectNotesRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(RatTrap.Business.ProjectNotesRecord);
                    this.DataSource = (ProjectNotesRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual ProjectNotesRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(ProjectNotesTable.Column1, true);          
            // selCols.Add(ProjectNotesTable.Column2, true);          
            // selCols.Add(ProjectNotesTable.Column3, true);          
                  ...
                  
            {
                ...
                return ProjectNotesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                ProjectNotesTable databaseTable = new ProjectNotesTable();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(ProjectNotesRecord)) as ProjectNotesRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return ProjectNotesTable.GetRecordCount(join, where);
            else
            {
                ProjectNotesTable databaseTable = new ProjectNotesTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        {
            // This CreateWhereClause is used for loading the data.
            ProjectNotesTable.Instance.InnerFilter = null;
            WhereClause wc = new WhereClause();
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue projectsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = projectsRecordObj;
          projectsRecordObj = tmp;
        ProjectsTableControlRow projectsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "ProjectsTableControlRow") as ProjectsTableControlRow);
          
              if (projectsTableControlObjRow != null && projectsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(ProjectNotesTable.ProjectId, BaseFilter.ComparisonOperator.EqualsTo, projectsTableControlObjRow.GetRecord().ProjectId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInProjectsTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(ProjectNotesTable.ProjectId))
      {
      wc.iAND(ProjectNotesTable.ProjectId, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(ProjectNotesTable.ProjectId).ToString());
      }
      ...
      ProjectNotesRecord rec = new ProjectNotesRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new ProjectNotesRecord());
                newUIDataList.Insert(0, new Hashtable());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(RatTrap.Business.ProjectNotesRecord);
                this.DataSource = (ProjectNotesRecord[])(finalList.ToArray(myrec));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        protected virtual void SortControl3_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  {
                  SelVal1 = SelVal1.Replace(words1[words1.Length - 1], "").TrimEnd();
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in ProjectNotesTable.GetColumns())
                  {
                  if (ColumnNam.Name.ToUpper().Equals(SelVal1))
                  {
                  SelVal1 = ColumnNam.InternalName;
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(ProjectNotesTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (ProjectNotesTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && ProjectNotesTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(ProjectNotesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(ProjectNotesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = ProjectNotesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  ProjectNotesRecord[] DataSource {
            ...
            get {
                return (ProjectNotesRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
// Base class for the ProjectsTableControlRow control on the Show_Projects_Table page.
...
public class BaseProjectsTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.AreaId.Click += AreaId_Click;
        ...
        public virtual void SetAreaId()
        {
            ...
            // Set the AreaId LinkButton on the webpage with value from the
            ...
            // this.AreaId is the ASP:LinkButton on the webpage.
                  
            if (this.DataSource != null && this.DataSource.AreaIdSpecified) {
                								
                // If the AreaId is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = ProjectsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(ProjectsTable.AreaId);
               if(_isExpandableNonCompositeForeignKey &&ProjectsTable.AreaId.IsApplyDisplayAs)
                                  
                     formattedValue = ProjectsTable.GetDFKA(this.DataSource.AreaId.ToString(),ProjectsTable.AreaId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(ProjectsTable.AreaId);
                                  
                                
                this.AreaId.Text = formattedValue;
                
                  this.AreaId.ToolTip = "Go to " + this.AreaId.Text.Replace("<wbr/>", "");
                   
            } 
            
            else {
            
                // AreaId is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.AreaId.Text = ProjectsTable.AreaId.Format(ProjectsTable.AreaId.DefaultValue);
        ...
        public virtual void SetAreaIdLabel()
                  {
        ...
        public virtual void SetGroupsTableControl()           
      ...
      this.Page.CommitTransaction(sender);
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Projects/Edit-Projects-Table.aspx?Projects={ProjectsTableControlRow:PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ProjectsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "ProjectsTableControl") as ProjectsTableControl);

          ProjectsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (ProjectsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "ProjectsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
        ...
        // event handler for LinkButton
        public virtual void AreaId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Areas/Show-Areas.aspx?Areas={ProjectsTableControlRow:FK:FK_Projects_Areas}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton AreaId {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AreaId");
            }
        }
            
        public System.Web.UI.WebControls.Literal AreaIdLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AreaIdLabel");
            }
        }
        ...
        public GroupsTableControl GroupsTableControl {
            get {
                return (GroupsTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "GroupsTableControl");
            }
        }
...
// Base class for the ProjectsTableControl control on the Show_Projects_Table page.
...
public class BaseProjectsTableControl : RatTrap.UI.BaseApplicationTableControl
{
       ...
       public BaseProjectsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.AreaIdFilter)) 				
                    initialVal = this.GetFromSession(this.AreaIdFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"AreaId\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] AreaIdFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in AreaIdFilteritemListFromSession)
                    {
                        if (index == 0 && item.ToString().Equals(""))
                        {
                            // do nothing
                        ...
                        {
                            this.AreaIdFilter.Items.Add(item);
                            this.AreaIdFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.AreaIdFilter.Items)
                    {
                        listItem.Selected = true;
                    }
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.SortControl.SelectedIndexChanged += new EventHandler(SortControl_SelectedIndexChanged);
              ...
              this.AreaIdFilter.SelectedIndexChanged += AreaIdFilter_SelectedIndexChanged;                  
      ...
      public override void DataBind()
      {
        ...
        ProjectsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "ProjectsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(ProjectsTable.AreaId, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.AreaIdFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.AreaIdFilter)) {
                ...
                int selectedItemCount = 0;
                foreach (ListItem item in this.AreaIdFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.AreaIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(ProjectsTable.AreaId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String AreaIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "AreaIdFilter_Ajax"];
            if (MiscUtils.IsValueSelected(AreaIdFilterSelectedValue)) {

              
        if (AreaIdFilterSelectedValue != null){
                        string[] AreaIdFilteritemListFromSession = AreaIdFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in AreaIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(ProjectsTable.AreaId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      ProjectsRecord rec = new ProjectsRecord();
                        ...
                        if (recControl.AreaId.Text != "") {
                            rec.Parse(recControl.AreaId.Text, ProjectsTable.AreaId);
                  }
        ...
        public virtual void SetAreaIdLabel1()
                  {
        ...
        public virtual void SetAreaIdFilter()
        {
            
            ArrayList AreaIdFilterselectedFilterItemList = new ArrayList();
            string AreaIdFilteritemsString = null;
            if (this.InSession(this.AreaIdFilter))
                AreaIdFilteritemsString = this.GetFromSession(this.AreaIdFilter);
            
            if (AreaIdFilteritemsString != null)
            {
                string[] AreaIdFilteritemListFromSession = AreaIdFilteritemsString.Split(',');
                foreach (string item in AreaIdFilteritemListFromSession)
                {
                    AreaIdFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateAreaIdFilter(MiscUtils.GetSelectedValueList(this.AreaIdFilter, AreaIdFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Areas/Areas-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.AreaIdFilter.ClientID + "&Formula=" + (this.Page as BaseApplicationPage).Encrypt("= Areas.Name")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("AreaId")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.AreaIdFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(AreaIdFilter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Area {Txt:Ascending}"), "AreaId Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Area {Txt:Descending}"), "AreaId Desc"));
        ...
        // Get the filters' data for AreaIdFilter.
                
        protected virtual void PopulateAreaIdFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_AreaIdFilter();            
            this.AreaIdFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_AreaIdFilter function.
            // It is better to customize the where clause there.
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    itemValues = AreasTable.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (AreasRecord itemValue in itemValues) 
                    {
                        // Create the item and add to the list.
                        string cvalue = null;
                        string fvalue = null;
                        if (itemValue.AreaIdSpecified) 
                        {
                            cvalue = itemValue.AreaId.ToString();
                            if (counter < maxItems && this.AreaIdFilter.Items.FindByValue(cvalue) == null)
                            {
                                    
                                Boolean _isExpandableNonCompositeForeignKey = ProjectsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(ProjectsTable.AreaId);
                                if(_isExpandableNonCompositeForeignKey && ProjectsTable.AreaId.IsApplyDisplayAs)
                                     fvalue = ProjectsTable.GetDFKA(itemValue, ProjectsTable.AreaId);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                     fvalue = itemValue.Format(AreasTable.AreaId);
                                ...
                                ListItem dupItem = this.AreaIdFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.AreaIdFilter.Items.Add(newItem);
            ...
            this.AreaIdFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.AreaIdFilter.Items.Count == 0)
                this.AreaIdFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "RatTrap"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_AreaIdFilter()
        {
            // Create a where clause for the filter AreaIdFilter.
            // This function is called by the Populate method to load the items 
            // in the AreaIdFilterQuickSelector
            ...
            AreaIdFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.AreaIdFilter, AreaIdFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (AreaIdFilterselectedFilterItemList == null || AreaIdFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in AreaIdFilterselectedFilterItemList)
                {
            	  
                    wc.iOR(AreasTable.AreaId, BaseFilter.ComparisonOperator.EqualsTo, item);                  
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList AreaIdFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.AreaIdFilter, null);
            string AreaIdFilterSessionString = "";
            if (AreaIdFilterselectedFilterItemList != null){
                foreach (string item in AreaIdFilterselectedFilterItemList){
                    AreaIdFilterSessionString = String.Concat(AreaIdFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.AreaIdFilter, AreaIdFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("AreaIdFilter_Ajax", AreaIdFilterSessionString);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.AreaIdFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Projects" ;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(AreaIdFilter))
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = ProjectsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
             ...
             ProjectsTable.AreaId,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(ProjectsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(ProjectsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(ProjectsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(ProjectsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(ProjectsTable.Description, "Default"));
             data.ColumnList.Add(new ExcelColumn(ProjectsTable.AreaId, "Default"));
              ...
              {
                val = ProjectsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Projects-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Projects";
                // If Show-Projects-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(ProjectsTable.Description.Name, ReportEnum.Align.Left, "${Description}", ReportEnum.Align.Left, 28);
                 report.AddColumn(ProjectsTable.AreaId.Name, ReportEnum.Align.Left, "${AreaId}", ReportEnum.Align.Left, 15);
                ...
                ColumnList columns = ProjectsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = ProjectsTable.GetRecordCount(joinFilter,whereClause);
                ProjectsRecord[] records = null;
                
                do
                {
                    
                    records = ProjectsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( ProjectsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Description}", record.Format(ProjectsTable.Description), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.AreaId)){
                                 report.AddData("${AreaId}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = ProjectsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(ProjectsTable.AreaId);
                                 _DFKA = ProjectsTable.GetDFKA(record.AreaId.ToString(), ProjectsTable.AreaId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  ProjectsTable.AreaId.IsApplyDisplayAs){
                                     report.AddData("${AreaId}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${AreaId}", record.Format(ProjectsTable.AreaId), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Projects-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Projects";
                // If Show-Projects-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for FieldFilter
        protected virtual void AreaIdFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector AreaIdFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AreaIdFilter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal AreaIdLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AreaIdLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual ProjectsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ProjectsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("RatTrap.UI.Controls.Show_Projects_Table.ProjectsTableControlRow")));
