...
// This file implements the code-behind class for Add_Projects.aspx.
// Add_Projects.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Projects
        : BaseApplicationPage
// Code-behind class for the Add_Projects page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProjectsTabContainer()
        {
            SetProjectsTabContainer_Base(); 
        }
        
        public void SetProjectNotesTableControl()
        {
            SetProjectNotesTableControl_Base(); 
        }
        
        public void SetProjectsRecordControl()
        {
            SetProjectsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Add_Projects.ProjectNotesTableControl ProjectNotesTableControl;
          
        public RatTrap.UI.Controls.Add_Projects.ProjectsRecordControl ProjectsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Projects");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ProjectNotesTableControl":
                 SetProjectNotesTableControl();
                 break;
          
              case "ProjectsRecordControl":
      ...
      public void SaveData_Base()
      {
        ...
        this.ProjectsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProjectsTabContainer_Base()           
        ...
        public void SetProjectNotesTableControl_Base()           
        ...
        public void SetProjectsRecordControl_Base()           
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ProjectsRecordControl != null && this.ProjectsRecordControl.DataSource != null)
                  {
                        id = this.ProjectsRecordControl.DataSource.GetValue(this.ProjectsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ProjectsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ProjectsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ProjectsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ProjectsRecordControl.DataSource.GetValue(this.ProjectsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
