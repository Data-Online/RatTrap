...
// This file implements the code-behind class for Show_Projects_Table.aspx.
// Show_Projects_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Projects_Table
        : BaseApplicationPage
// Code-behind class for the Show_Projects_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Projects_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public RatTrap.UI.Controls.Show_Projects_Table.ProjectsTableControl ProjectsTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        RatTrap.UI.Controls.Show_Projects_Table.ProjectsTableControl control = new RatTrap.UI.Controls.Show_Projects_Table.ProjectsTableControl();
    ...
    public static string[] GetAutoCompletionList_SearchText2_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        RatTrap.UI.Controls.Show_Projects_Table.GroupsTableControl control = new RatTrap.UI.Controls.Show_Projects_Table.GroupsTableControl();
