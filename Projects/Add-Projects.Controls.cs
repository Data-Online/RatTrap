...
// Add_Projects.aspx page.  The Row or RecordControl classes are the 
...
namespace RatTrap.UI.Controls.Add_Projects
{
...
// Base class for the ProjectNotesTableControlRow control on the Add_Projects page.
...
public class BaseProjectNotesTableControlRow : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetNote()
        {
            ...
            this.DataSource.Parse(this.Note.Text, ProjectNotesTable.Note);							
      ...
      // To customize, override this method in ProjectNotesTableControlRow.
        ...
        ProjectNotesTableControl tc= ((ProjectNotesTableControl)MiscUtils.GetParentControlObject(this, "ProjectNotesTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((ProjectNotesTableControlRow)this);
                    }
                    this.Visible = false;
...
// Base class for the ProjectNotesTableControl control on the Add_Projects page.
...
public class BaseProjectNotesTableControl : RatTrap.UI.BaseApplicationTableControl
{
    ...
    RatTrap.UI.Controls.Add_Projects.ProjectsRecordControl projectsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ProjectsRecordControl") as RatTrap.UI.Controls.Add_Projects.ProjectsRecordControl);
      ...
      ProjectNotesRecord rec = new ProjectNotesRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("ProjectNotesTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (ProjectNotesTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        ProjectNotesTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual ProjectNotesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ProjectNotesTableControlRow[])(selectedList.ToArray(Type.GetType("RatTrap.UI.Controls.Add_Projects.ProjectNotesTableControlRow")));
...
// Base class for the ProjectsRecordControl control on the Add_Projects page.
...
public class BaseProjectsRecordControl : RatTrap.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (ProjectsRecord)ProjectsRecord.Copy(recList[0], false);
        ...
        public virtual void SetAreaId()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"AreaId\")");
      ...
      // To customize, override this method in ProjectsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Projects"];
            ...
            HttpContext.Current.Session["QueryString in Add-Projects"] = recId;
